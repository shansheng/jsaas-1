...
alter table ACT_RU_TASK add OVERTIME_ TIMESTAMP null;
alter table ACT_RU_TASK add OVERTIME_ZONE_ VARCHAR2(64) null;
...
COMMENT ON COLUMN ACT_RU_TASK.OVERTIME_ IS '超时时刻';
COMMENT ON COLUMN ACT_RU_TASK.OVERTIME_ZONE_ IS '超时设定的时长';
