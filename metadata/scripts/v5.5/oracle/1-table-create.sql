...
/* Created on:     2018-2-7 上午 9:23:19                          */
/*==============================================================*/
...
CREATE TABLE BPM_FORMBO_SETTING  (
   ...
   UPDATE_TIME_         TIMESTAMP,
   TENANT_ID_           VARCHAR2(64),
   CONSTRAINT PK_BPM_FORMBO_SETTING PRIMARY KEY (ID_)
);
...
COMMENT ON COLUMN BPM_FV_RIGHT.DEALWITH_ IS
'子表添加数据处理';
...
CREATE TABLE "HR_DUTY_REGISTER"  (
   ...
   SYSTEM_ID_           VARCHAR2(64),
   SECTION_ID_          VARCHAR2(64),
   LONGITUDE_           NUMBER(11,3),
   LATITUDE_            NUMBER(11,3),
   ADDRESSES_           VARCHAR2(64),
   SIGNREMARK_          VARCHAR2(300),
   DISTANCE_            INTEGER,
   DATE_                TIMESTAMP,
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
...
COMMENT ON COLUMN "HR_DUTY_REGISTER".LONGITUDE_ IS
'经度';

COMMENT ON COLUMN "HR_DUTY_REGISTER".LATITUDE_ IS
'维度';

COMMENT ON COLUMN "HR_DUTY_REGISTER".ADDRESSES_ IS
'地址详情';

COMMENT ON COLUMN "HR_DUTY_REGISTER".SIGNREMARK_ IS
'签到备注';

COMMENT ON COLUMN "HR_DUTY_REGISTER".DISTANCE_ IS
'签到增加距离';
