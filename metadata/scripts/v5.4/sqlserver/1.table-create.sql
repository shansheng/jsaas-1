...
/* Created on:     2017/7/17 星期一 下午 4:55:02                     */
/*==============================================================*/
...
CREATE TABLE BPM_SOL_FV (
   ...
   INIT_SETTING_        VARCHAR(2000)        NULL,
   SAVE_SETTING_        VARCHAR(2000)        NULL
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '表单初始数据设定',
   'user', @CURRENTUSER, 'table', 'BPM_SOL_FV', 'column', 'INIT_SETTING_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '表单初始数据设定',
   'user', @CURRENTUSER, 'table', 'BPM_SOL_FV', 'column', 'SAVE_SETTING_'
go
...
CREATE TABLE INS_COLUMN (
   ...
   NUMS_OF_PAGE_        INT                  NULL,
   ALLOW_CLOSE_         VARCHAR(20)          NULL,
   COL_TYPE_            VARCHAR(50)          NULL,
   TENANT_ID_           VARCHAR(64)          NULL,
   CREATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '信息栏目',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目ID',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'COL_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目名称',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目Key',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'KEY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否启用',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'ENABLED_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '每页记录数',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'NUMS_OF_PAGE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否允许关闭',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'ALLOW_CLOSE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   公司或单位新闻
   部门新闻',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'COL_TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'INS_COLUMN', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目ID',
   'user', @CURRENTUSER, 'table', 'INS_COL_NEW', 'column', 'COL_ID_'
go
...
CREATE TABLE INS_COL_TYPE (
   ...
   MORE_URL_            VARCHAR(100)         NULL,
   LOAD_TYPE_           VARCHAR(20)          NULL,
   TEMP_ID_             VARCHAR(64)          NULL,
   TEMP_NAME_           VARCHAR(64)          NULL,
   ICON_CLS_            VARCHAR(20)          NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目分类表',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目名称',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目Key',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'KEY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目映射URL',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'URL_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   URL=URL
   TEMPLATE=模板',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'LOAD_TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '模板ID',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'TEMP_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '模板名称',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'TEMP_NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目分类描述',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'MEMO_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'INS_COL_TYPE', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'PORTAL门户定义',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '门户名称',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   部门门户
   知识门户',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'KEY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '列数',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'COL_NUMS_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目宽
   三列格式如250,100%,400',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'COL_WIDTHS_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否为系统缺省',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'IS_DEFAULT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '描述',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'DESC_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'INS_PORTAL', 'column', 'UPDATE_TIME_'
go
...
CREATE TABLE INS_PORT_COL (
   CONF_ID_             VARCHAR(64)          NOT NULL,
   PORT_ID_             VARCHAR(64)          NOT NULL,
   COL_ID_              VARCHAR(64)          NOT NULL,
   WIDTH_               INT                  NULL,
   HEIGHT_              INT                  NOT NULL,
   WIDTH_UNIT_          VARCHAR(8)           NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '门户栏目配置',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '门户ID',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'PORT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '栏目ID',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'COL_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '宽度',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'WIDTH_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '高度',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'HEIGHT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   百份比=%
   像数=px',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'WIDTH_UNIT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   百份比=%
   像数=px',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'HEIGHT_UNIT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '列号',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'COL_NUM_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '列中序号',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'SN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'INS_PORT_COL', 'column', 'UPDATE_TIME_'
go
...
CREATE TABLE SYS_CUSTOM_QUERY (
   ...
   ORDER_FIELD_         VARCHAR(100)         NULL,
   DS_ALIAS_            VARCHAR(64)          NULL,
   TABLE_               INT                  NULL,
   SQL_DIY_             TEXT                 NULL,
   SQL_BUILD_TYPE_      INT                  NULL,
   TENANT_ID_           VARCHAR(64)          NULL,
   CREATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
...
CREATE TABLE SYS_LOG (
   LOG_ID_              VARCHAR(64)          NOT NULL,
   OP_SUBJECT_          VARCHAR(256)         NOT NULL,
   OP_DESCP_            TEXT                 NULL,
   OP_USID_             VARCHAR(64)          NOT NULL,
   EXE_CLS_METHOD_      VARCHAR(256)         NOT NULL,
   ERR_LOG_             TEXT                 NOT NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '日志ID',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'LOG_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '操作描述',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'OP_SUBJECT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '操作详述',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'OP_DESCP_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '操作人ID',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'OP_USID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '执行的详细类及方法',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'EXE_CLS_METHOD_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '出错详细日志',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'ERR_LOG_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'SYS_LOG', 'column', 'CREATE_TIME_'
go
...
CREATE TABLE SYS_LOG_CONF (
   ...
   PATH_                VARCHAR(255)         NOT NULL,
   IS_ENABLED_          VARCHAR(20)          NOT NULL,
   CAT_                 VARCHAR(100)         NOT NULL
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '日志配置',
   'user', @CURRENTUSER, 'table', 'SYS_LOG_CONF'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '配置ID',
   'user', @CURRENTUSER, 'table', 'SYS_LOG_CONF', 'column', 'CONF_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '等级',
   'user', @CURRENTUSER, 'table', 'SYS_LOG_CONF', 'column', 'LEVEL_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '包名路径',
   'user', @CURRENTUSER, 'table', 'SYS_LOG_CONF', 'column', 'PATH_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否开启',
   'user', @CURRENTUSER, 'table', 'SYS_LOG_CONF', 'column', 'IS_ENABLED_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '日志分类',
   'user', @CURRENTUSER, 'table', 'SYS_LOG_CONF', 'column', 'CAT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   NO=为租户可访问的菜单 
   YES=为平台管理员可访问的菜单',
   'user', @CURRENTUSER, 'table', 'SYS_MENU', 'column', 'IS_MGR_'
go
...
CREATE TABLE WX_P_ARTICLE (
   ARTICLE_ID_          VARCHAR(64)          NOT NULL,
   AUTHOR_              VARCHAR(255)         NULL,
   TITLE_               VARCHAR(255)         NULL,
   CONTENT_SOURCE_URL_  VARCHAR(255)         NULL,
   CONTENT_             TEXT                 NULL,
   DIGEST_              VARCHAR(255)         NULL,
   SHOW_COVER_PIC_      VARCHAR(64)          NULL,
   MATERIAL_ID_         VARCHAR(64)          NULL,
   FILE_ID_             VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
   UPDATE_TIME_         DATETIME             NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '非SAAS微信文章',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '作者',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'AUTHOR_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '标题',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'TITLE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '原文章地址',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'CONTENT_SOURCE_URL_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文消息页面的内容',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'CONTENT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文消息的描述',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'DIGEST_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否显示封面',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'SHOW_COVER_PIC_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_ARTICLE', 'column', 'CREATE_BY_'
go
...
CREATE TABLE WX_P_CONFIG (
   CONFIG_ID_           VARCHAR(64)          NOT NULL,
   INIT_ID_             VARCHAR(256)         NULL,
   TENANT_NAME_CN_      VARCHAR(256)         NULL,
   APP_TOKEN_           VARCHAR(256)         NULL,
   APP_ID_              VARCHAR(256)         NULL,
   APP_SECRET_          VARCHAR(256)         NULL,
   ACCESS_TOKEN_        VARCHAR(256)         NULL,
   EXPIRES_IN_          VARCHAR(256)         NULL,
   EXPIRES_TIME_        BIGINT               NULL,
   TENANT_ID_           VARCHAR(64)          NULL,
   UPDATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'CONFIG_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '原始ID',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'INIT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租户名称',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'TENANT_NAME_CN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '应用凭证',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'APP_TOKEN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '应用ID',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'APP_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '应用密钥',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'APP_SECRET_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '获取到的凭证(访问凭证)',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'ACCESS_TOKEN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '凭证有效时间，单位：秒',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'EXPIRES_IN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '凭证过期时间',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'EXPIRES_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_CONFIG', 'column', 'CREATE_BY_'
go
...
CREATE TABLE WX_P_MATERIAL (
   MATERIAL_ID_         VARCHAR(64)          NOT NULL,
   NAME_                VARCHAR(64)          NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '非SAAS微信素材',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'MATERIAL_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '名称',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '媒体文件类型',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '文件id',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'FILE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MATERIAL', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'MENU_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '菜单名称',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '菜单Key',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'KEY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '上级父ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'PARENT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '序号',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'SN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '访???地址URL',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'URL_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '访问方式\r\n',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '树的编码',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'TREE_CODE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'path',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'PATH_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MENU', 'column', 'CREATE_BY_'
go
...
CREATE TABLE WX_P_MO_TEXT (
   TEXT_ID_             VARCHAR(64)          NOT NULL,
   TO_USER_NAEM__       VARCHAR(256)         NULL,
   FROM_USER_NAME_      VARCHAR(256)         NULL,
   MSG_TYPE_            VARCHAR(256)         NULL,
   CONTENT_             TEXT                 NULL,
   MSGID_               VARCHAR(256)         NULL,
   CREATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
   UPDATE_TIME_         DATETIME             NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'TEXT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '接收?????户openID',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'TO_USER_NAEM__'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '发送的用???openID',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'FROM_USER_NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '消息类型',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'MSG_TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '内容',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'CONTENT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '消息id',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'MSGID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MO_TEXT', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信公共号信息',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'MSG_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '代理应用ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'AGENTID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '用户ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'USER_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '内容',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'CONTENT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '状态',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'STATUS_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MSG', 'column', 'CREATE_BY_'
go
...
CREATE TABLE WX_P_MT_ARTICLE (
   MT_ARTICLE_ID_       VARCHAR(64)          NOT NULL,
   ARTICLE_ID_          VARCHAR(64)          NULL,
   THUMB_MEDIA_ID_      VARCHAR(255)         NULL,
   CREATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
   UPDATE_TIME_         DATETIME             NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信下的文章',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'MT_ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '素材ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'THUMB_MEDIA_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_ARTICLE', 'column', 'TENANT_ID_'
go
...
CREATE TABLE WX_P_MT_MATERIAL_TEMP (
   MT_MATERIAL_TEMP_ID_ VARCHAR(64)          NOT NULL,
   NAME_                VARCHAR(64)          NULL,
   TYPE_                VARCHAR(128)         NULL,
   MEDIA_ID_            VARCHAR(512)         NULL,
   CREATED_AT_          VARCHAR(256)         NULL,
   MATERIAL_ID_         VARCHAR(64)          NULL,
   CREATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'MT_MATERIAL_TEMP_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '名称',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '???体文件类型',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '媒体id',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'MEDIA_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'CREATED_AT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '文件id',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'MATERIAL_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_MATERIAL_TEMP', 'column', 'TENANT_ID_'
go
...
CREATE TABLE WX_P_MT_NEWS (
   MT_NEWS_ID_          VARCHAR(64)          NOT NULL,
   NAME_                VARCHAR(256)         NULL,
   MEDIA_ID_            VARCHAR(256)         NULL,
   TYPE_                VARCHAR(128)         NULL,
   CREATED_AT_          VARCHAR(256)         NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'MT_NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '名称',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '媒体文章ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'MEDIA_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '类型',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'CREATED_AT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_NEWS', 'column', 'TENANT_ID_'
go
...
CREATE TABLE WX_P_MT_USER_NEWS (
   MT_USER_NEWS_ID_     VARCHAR(64)          NOT NULL,
   MEDIA_ID_            VARCHAR(256)         NULL,
   USER_NEWS_ID_        VARCHAR(64)          NULL,
   TENANT_ID_           VARCHAR(64)          NULL,
   UPDATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
   CREATE_TIME_         DATETIME             NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'MT_USER_NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '用于群发的??文消息的media_id',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'MEDIA_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '群发的消息类型',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'USER_NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_MT_USER_NEWS', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '非SAAS微信图文',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '??称',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '类型',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS', 'column', 'CREATE_TIME_'
go
...
CREATE TABLE WX_P_NEWS_ARTICLE (
   NEWS_ARTICLE_ID_     VARCHAR(64)          NOT NULL,
   SN_                  INT                  NULL,
   NEWS_ID_             VARCHAR(64)          NULL,
   ARTICLE_ID_          VARCHAR(64)          NULL,
   CREATE_BY_           VARCHAR(64)          NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '非SAAS微信图文与文章',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'NEWS_ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '序号',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'SN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '文章ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_NEWS_ARTICLE', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信文章(SAAS功能)',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '作者',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'AUTHOR_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '标题',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'TITLE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '原文章地址',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'CONTENT_SOURCE_URL_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文消息页面的内容',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'CONTENT_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文消息的描述',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'DIGEST_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否显示封面',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'SHOW_COVER_PIC_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_ARTICLE', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信素材(SAAS功能)',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'MATERIAL_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '名称',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '媒体文件类型',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '文件id',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'FILE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_MATERIAL', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信消息(SAAS功能)',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '??称',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '类型',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信消息与文章(SAAS功能)',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'NEWS_ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '序号',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'SN_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '文章ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'ARTICLE_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_NEWS_ARTICLE', 'column', 'TENANT_ID_'
go
...
CREATE TABLE WX_P_SAAS_USER_NEWS (
   USER_NEWS_ID_        VARCHAR(64)          NOT NULL,
   NAME_                VARCHAR(256)         NULL,
   IS_MASS_             VARCHAR(64)          NULL,
   TOUSER_              TEXT                 NULL,
   FULLNAME_            VARCHAR(64)          NULL,
   NEWS_ID_             VARCHAR(64)          NULL,
   MSGTYPE_             VARCHAR(128)         NULL,
   ERRCODE_             VARCHAR(64)          NULL,
   STATUS_              SMALLINT             NULL,
   TENANT_ID_           VARCHAR(64)          NULL,
   UPDATE_TIME_         DATETIME             NULL,
   UPDATE_BY_           VARCHAR(64)          NULL,
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信用户消息(SAAS功能)',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'USER_NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文名称',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否群发',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'IS_MASS_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '填写图文消息的接收者',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'TOUSER_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '姓名',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'FULLNAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '群发的消息类型',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'MSGTYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '错误码',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'ERRCODE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '状态',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'STATUS_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_SAAS_USER_NEWS', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信公众号用户',
   'user', @CURRENTUSER, 'table', 'WX_P_USER'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '用户ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'USER_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '姓名',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'FULLNAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信号ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'WEIXIN_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '微信用户昵称',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'NICK_NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '状态',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'STATUS_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'TENANT_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '非SAAS微信用户图文',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'USER_NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文名称',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'NAME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '填写图文消息的接收者',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'TOUSER_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '图文ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'NEWS_ID_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '群发的消息类型',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'MSGTYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新时间',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'UPDATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '更新人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'UPDATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'CREATE_TIME_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'CREATE_BY_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '租用机构ID',
   'user', @CURRENTUSER, 'table', 'WX_P_USER_NEWS', 'column', 'TENANT_ID_'
go
