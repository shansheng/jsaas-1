/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2017-8-17 下午 2:43:47                         */
/*==============================================================*/
...
(
   ...
   IS_BIND_MD_          VARCHAR(20) COMMENT '是否绑定业务模型
            YES=是
            NO=否',
   TEMPLATE_VIEW_       LONGTEXT COMMENT '模板类型ID
            用于生成视图的模板类型ID',
...
(
   ...
   VIEW_ID_             VARCHAR(64) COMMENT '业务表单视图ID',
   ACT_DEF_ID_          VARCHAR(64) COMMENT 'Activiti定义ID',
   ...
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人ID',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   TYPE_                VARCHAR(64) COMMENT '权限类型(field:字段,opinion:意见)',
...
(
   SCRIPT_ID_           VARCHAR(64) COMMENT '主键',
...
(
   ...
   ACT_DEF_ID_          CHAR(10) COMMENT '流程定义ID',
...
(
   ...
   KEY_                 VARCHAR(50) NOT NULL COMMENT '栏目Key',
   URL_                 VARCHAR(100) COMMENT '栏目映射URL',
...
(
   ...
   LIST_HTML_           LONGTEXT COMMENT '列表显示模板',
...
(
   ...
   DATA_HANDLER_        CHAR(10) COMMENT '数据处理器',
   PRIMARY KEY (ID_)
);
