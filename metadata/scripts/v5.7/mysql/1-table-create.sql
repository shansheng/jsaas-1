...
(
   ...
   TREE_ID_             VARCHAR(64) COMMENT '分类Id',
   NAME_                VARCHAR(64) COMMENT '名称',
   CONTROL_TYPE_        VARCHAR(64) COMMENT '类型(radio-list checkbox-list textbox number DATETIME textarea)',
   DATA_TYPE_           VARCHAR(20) COMMENT '数据类型(string number DATETIME 大文本)',
...
(
   ...
   TITLE_FIELD_         VARCHAR(2000) COMMENT 'title字段定义',
   LEGEND_FIELD_        VARCHAR(2000) COMMENT '图例字段定义',
   XAXIS_FIELD_         VARCHAR(2000) COMMENT 'x轴坐标定义',
   XAXIS_DATA_FIELD_    TEXT COMMENT 'x轴data定义',
   XY_CONVERT_          INT COMMENT 'x轴y轴转换',
   DATA_FIELD_          VARCHAR(2000) COMMENT '结果字段定义',
   SERIES_FIELD_        VARCHAR(2000) COMMENT '系列列表字段定义',
   ...
   DRILL_DOWN_FIELD_    VARCHAR(2000) COMMENT '下钻字段定义',
   DRILL_DOWN_KEY_      VARCHAR(100) COMMENT '下钻key值',
   GRID_FIELD_          VARCHAR(2000) COMMENT 'grid字段定义',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人ID',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人ID',
...
(
   ...
   PDF_PATH_            VARCHAR(100) COMMENT 'PDF路径',
...
ALTER TABLE SYS_INVOKE_SCRIPT COMMENT '执行脚本配置';
...
(
   ...
   TYPE_                VARCHAR(10) COMMENT '类型(内部外部)',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人ID',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人ID',
