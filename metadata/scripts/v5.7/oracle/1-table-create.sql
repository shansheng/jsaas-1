...
'类型(radio-list checkbox-list textbox number datetime textarea)';

COMMENT ON COLUMN OA_PRODUCT_DEF_PARA_KEY.DATA_TYPE_ IS
'数据类型(string number datetime 大文本)';
...
COMMENT ON COLUMN SYS_DATASOURCE_DEF.TENANT_ID_ IS
'租用用户Id';
...
CREATE TABLE SYS_ECHARTS_CUSTOM  (
   ...
   TITLE_FIELD_         VARCHAR2(2000),
   LEGEND_FIELD_        VARCHAR2(2000),
   XAXIS_FIELD_         VARCHAR2(2000),
   XAXIS_DATA_FIELD_    CLOB,
   XY_CONVERT_          INTEGER,
   DATA_FIELD_          VARCHAR2(2000),
   SERIES_FIELD_        VARCHAR2(2000),
   ...
   SQL_BUILD_TYPE_      VARCHAR2(20),
   SQL_                 VARCHAR2(2000),
   GRID_FIELD_          VARCHAR2(2000),
   DRILL_DOWN_KEY_      VARCHAR2(128),
   DRILL_DOWN_FIELD_    VARCHAR2(2000),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
