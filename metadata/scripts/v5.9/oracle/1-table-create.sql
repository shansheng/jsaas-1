...
COMMENT ON COLUMN ATS_SHIFT_INFO.CODE IS
'编码';
...
CREATE TABLE BPM_BATCH_APPROVAL  (
   ...
   STATUS_              VARCHAR2(4),
   SOL_NAME_            VARCHAR2(200),
   TASK_NAME_           VARCHAR2(200),
...
COMMENT ON COLUMN BPM_BATCH_APPROVAL.SOL_NAME_ IS
'解决方案名称';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.TASK_NAME_ IS
'节点名称';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.ACT_DEF_ID_ IS
'流程定义ID';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.UPDATE_TIME_ IS
'更新时间';

COMMENT ON COLUMN BPM_BATCH_APPROVAL.UPDATE_BY_ IS
'更新人';
...
CREATE TABLE BPM_FORMULA_MAPPING  (
   ...
   FORMULA_ID_          VARCHAR2(64),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_BPM_FORMULA_MAPPING PRIMARY KEY (ID_)
);

COMMENT ON TABLE BPM_FORMULA_MAPPING IS
'公式映射';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.ID_ IS
'主键';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.SOL_ID_ IS
'方案ID';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.ACT_DEF_ID_ IS
'流程定义ID';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.NODE_ID_ IS
'节点ID';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.FORMULA_NAME IS
'公式名';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.FORMULA_ID_ IS
'公式ID';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN BPM_FORMULA_MAPPING.UPDATE_TIME_ IS
'更新时间';
...
COMMENT ON COLUMN BPM_INST.SOL_KEY_ IS
'业务解决方案KEY';
...
CREATE TABLE BPM_OVERTIME_NODE  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_BPM_OVERTIME_NODE PRIMARY KEY (ID_)
);

COMMENT ON TABLE BPM_OVERTIME_NODE IS
'流程超时节点表';

COMMENT ON COLUMN BPM_OVERTIME_NODE.SOL_ID_ IS
'解决方案ID';

COMMENT ON COLUMN BPM_OVERTIME_NODE.INST_ID_ IS
'流程实例ID';

COMMENT ON COLUMN BPM_OVERTIME_NODE.NODE_ID_ IS
'流程节点ID';

COMMENT ON COLUMN BPM_OVERTIME_NODE.OP_TYPE_ IS
'操作类型';

COMMENT ON COLUMN BPM_OVERTIME_NODE.OP_CONTENT_ IS
'操作内容';

COMMENT ON COLUMN BPM_OVERTIME_NODE.OVERTIME_ IS
'超时时间';

COMMENT ON COLUMN BPM_OVERTIME_NODE.STATUS_ IS
'节点状态';

COMMENT ON COLUMN BPM_OVERTIME_NODE.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN BPM_OVERTIME_NODE.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN BPM_OVERTIME_NODE.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN BPM_OVERTIME_NODE.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN BPM_OVERTIME_NODE.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE BPM_REG_LIB  (
   ...
   USER_ID_             VARCHAR2(64)                    NOT NULL,
   REG_TEXT_            VARCHAR2(512)                   NOT NULL,
   NAME_                VARCHAR2(64)                    NOT NULL,
   TYPE_                VARCHAR2(4)                     NOT NULL,
   KEY_                 VARCHAR2(64)                    NOT NULL,
   MENT_TEXT_           VARCHAR2(512)                   NOT NULL,
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_BPM_REG_LIB PRIMARY KEY (REG_ID_)
);

COMMENT ON TABLE BPM_REG_LIB IS
'正则表达式';

COMMENT ON COLUMN BPM_REG_LIB.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN BPM_REG_LIB.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN BPM_REG_LIB.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN BPM_REG_LIB.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN BPM_REG_LIB.UPDATE_TIME_ IS
'更新时间';
...
COMMENT ON COLUMN BPM_SOLUTION.ICON_ IS
'流程方案图标';

COMMENT ON COLUMN BPM_SOLUTION.COLOR_ IS
'流程方案图标颜色';
...
CREATE TABLE BPM_SOL_TEMPLATE_RIGHT  (
   RIGHT_ID_            VARCHAR2(64)                    NOT NULL,
   TREE_ID_             VARCHAR2(64),
   GROUP_IDS_           VARCHAR2(512),
   USER_IDS_            VARCHAR2(512),
   TENANT_ID_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   CREATE_BY_           VARCHAR2(64),
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   IS_ALL               VARCHAR2(64),
   CONSTRAINT PK_BPM_SOL_TEMPLATE_RIGHT PRIMARY KEY (RIGHT_ID_)
);

COMMENT ON TABLE BPM_SOL_TEMPLATE_RIGHT IS
'流程模板分类权限';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.RIGHT_ID_ IS
'权限ID';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.TREE_ID_ IS
'分类ID';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.GROUP_IDS_ IS
'组IDS';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.USER_IDS_ IS
'用户IDS';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN BPM_SOL_TEMPLATE_RIGHT.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE BPM_TABLE_FORMULA  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_BPM_TABLE_FORMULA PRIMARY KEY (ID_)
);

COMMENT ON TABLE BPM_TABLE_FORMULA IS
'表间公式';

COMMENT ON COLUMN BPM_TABLE_FORMULA.NAME_ IS
'公式名称';

COMMENT ON COLUMN BPM_TABLE_FORMULA.DESCP_ IS
'公式描述';

COMMENT ON COLUMN BPM_TABLE_FORMULA.TREE_ID_ IS
'分类ID';

COMMENT ON COLUMN BPM_TABLE_FORMULA.FILL_CONF_ IS
'数据填充配置';

COMMENT ON COLUMN BPM_TABLE_FORMULA.DS_NAME_ IS
'数据源';

COMMENT ON COLUMN BPM_TABLE_FORMULA.BO_DEF_ID_ IS
'数据模板ID';

COMMENT ON COLUMN BPM_TABLE_FORMULA.ACTION_ IS
'表单触发时机';

COMMENT ON COLUMN BPM_TABLE_FORMULA.TYPE_ IS
'表单方案=FORM_SOL 表单=FORM_VIEW, 业务流程方案=BPM_SOL';

COMMENT ON COLUMN BPM_TABLE_FORMULA.IS_TEST_ IS
'是否开启调试模式';

COMMENT ON COLUMN BPM_TABLE_FORMULA.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN BPM_TABLE_FORMULA.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN BPM_TABLE_FORMULA.CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN BPM_TABLE_FORMULA.UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN BPM_TABLE_FORMULA.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE FORM_VALID_RULE  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_FORM_VALID_RULE PRIMARY KEY (ID_)
);

COMMENT ON TABLE FORM_VALID_RULE IS
'表单验证规则';

COMMENT ON COLUMN FORM_VALID_RULE.ID_ IS
'主键';

COMMENT ON COLUMN FORM_VALID_RULE.SOL_ID_ IS
'解决方案ID';

COMMENT ON COLUMN FORM_VALID_RULE.FORM_KEY_ IS
'表单KEY';

COMMENT ON COLUMN FORM_VALID_RULE.NODE_ID_ IS
'节点ID';

COMMENT ON COLUMN FORM_VALID_RULE.ACT_DEF_ID_ IS
'流程定义ID';

COMMENT ON COLUMN FORM_VALID_RULE.JSON_ IS
'表单验证';

COMMENT ON COLUMN FORM_VALID_RULE.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN FORM_VALID_RULE.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN FORM_VALID_RULE.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN FORM_VALID_RULE.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN FORM_VALID_RULE.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE INF_INBOX  (
   ...
   REC_USER_ID_         VARCHAR2(2000),
   REC_TYPE_            VARCHAR2(20)                    NOT NULL,
   FULLNAME_            VARCHAR2(2000),
   GROUP_ID_            VARCHAR2(2000),
   GROUP_NAME_          VARCHAR2(2000),
...
COMMENT ON COLUMN INS_COLUMN_DEF.TREE_ID_ IS
'分类ID';

COMMENT ON COLUMN INS_COLUMN_DEF.TABGROUPS_ IS
'Tab标签组';
...
COMMENT ON COLUMN INS_COLUMN_DEF.NEW_TYPE_ IS
'新闻类型';
...
COMMENT ON COLUMN INS_PORTAL_DEF.IS_MOBILE_PORTAL_ IS
'是否手机门户';
...
COMMENT ON COLUMN LOG_MODULE.TENANT_ID_ IS
'机构ID';
...
COMMENT ON COLUMN OS_ATTRIBUTE_VALUE.COMBOBOX_NAME_ IS
'下拉框名称';
...
CREATE TABLE OS_INST_USERS  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CREATE_TYPE_         VARCHAR2(64),
   APPLY_STATUS_        VARCHAR2(64),
...
COMMENT ON COLUMN OS_INST_USERS.DOMAIN_ IS
'域';
...
COMMENT ON COLUMN OS_REL_TYPE.LEVEL_ IS
'等级';
...
COMMENT ON COLUMN OS_USER."DEFAULTDOMAIN" IS
'默认登陆机构域名';
...
COMMENT ON COLUMN SYS_BO_ENTITY.TREE_ID_ IS
'分类树ID';
...
COMMENT ON COLUMN SYS_BO_LIST.FORM_DETAIL_ALIAS_ IS
'明细表单';
...
CREATE TABLE SYS_CUSTOMFORM_SETTING  (
   ...
   EDIT_UK_             VARCHAR2(100),
   EDIT_UK_FROM_        VARCHAR2(20),
   EDIT_UK_CONF_        VARCHAR2(200),
   IS_TREE_             INTEGER,
...
COMMENT ON COLUMN SYS_CUSTOMFORM_SETTING.EDIT_UK_ IS
'编辑获值键';

COMMENT ON COLUMN SYS_CUSTOMFORM_SETTING.EDIT_UK_FROM_ IS
'键值源';

COMMENT ON COLUMN SYS_CUSTOMFORM_SETTING.EDIT_UK_CONF_ IS
'键值配置';
...
COMMENT ON COLUMN SYS_CUSTOMFORM_SETTING.PARAM_DEF_ IS
'外部关联配置';
...
COMMENT ON COLUMN SYS_CUSTOM_QUERY.TREE_ID_ IS
'分类ID';
...
CREATE TABLE SYS_DASHBOARD_CUSTOM  (
   ...
   LAYOUT_HTML_         CLOB,
   EDIT_HTML_           CLOB,
   QUERYFILTER_JSONSTR_ CLOB,
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_DASHBOARD_CUSTOM PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_DASHBOARD_CUSTOM IS
'自定义大屏';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.ID_ IS
'ID';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.NAME_ IS
'名称';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.KEY_ IS
'KEY';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.TREE_ID_ IS
'树ID';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.LAYOUT_HTML_ IS
'展示布局HTML';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.EDIT_HTML_ IS
'编辑布局HTML';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.QUERYFILTER_JSONSTR_ IS
'查询条件JSON字符';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN SYS_DASHBOARD_CUSTOM.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_DATA_BAT  (
   ID_                  VARCHAR2(64)                    NOT NULL,
   UPLOAD_ID_           VARCHAR2(64),
   BAT_ID_              VARCHAR2(64),
   SERVICE_NAME_        VARCHAR2(64),
   APP_ID_              VARCHAR2(64),
   TYPE_                VARCHAR2(64),
   EXCEL_ID_            VARCHAR2(64),
   TABLE_NAME_          VARCHAR2(64),
   INST_ID_             VARCHAR2(64),
   INST_STATUS_         VARCHAR2(64),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_DATA_BAT PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_DATA_BAT IS
'EXCEL导入批次';

COMMENT ON COLUMN SYS_DATA_BAT.ID_ IS
'主键';

COMMENT ON COLUMN SYS_DATA_BAT.UPLOAD_ID_ IS
'上传批次';

COMMENT ON COLUMN SYS_DATA_BAT.BAT_ID_ IS
'批次ID';

COMMENT ON COLUMN SYS_DATA_BAT.SERVICE_NAME_ IS
'服务名';

COMMENT ON COLUMN SYS_DATA_BAT.APP_ID_ IS
'应用ID';

COMMENT ON COLUMN SYS_DATA_BAT.TYPE_ IS
'类型';

COMMENT ON COLUMN SYS_DATA_BAT.EXCEL_ID_ IS
'EXCEL文件ID';

COMMENT ON COLUMN SYS_DATA_BAT.TABLE_NAME_ IS
'导入的表名';

COMMENT ON COLUMN SYS_DATA_BAT.INST_ID_ IS
'实例ID';

COMMENT ON COLUMN SYS_DATA_BAT.INST_STATUS_ IS
'实例状态';

COMMENT ON COLUMN SYS_DATA_BAT.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN SYS_DATA_BAT.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN SYS_DATA_BAT.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_DATA_BAT.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN SYS_DATA_BAT.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_ECHARTS_CUSTOM  (
   ...
   NAME_                VARCHAR2(64),
   KEY_                 VARCHAR2(64),
   ECHARTS_TYPE_        VARCHAR2(66),
   TITLE_FIELD_         CLOB,
   LEGEND_FIELD_        CLOB,
   XAXIS_FIELD_         CLOB,
   XAXIS_DATA_FIELD_    VARCHAR2(1000),
   XY_CONVERT_          INTEGER,
   DATA_FIELD_          CLOB,
   SERIES_FIELD_        CLOB,
   DETAIL_METHOD_       INTEGER,
   WHERE_FIELD_         VARCHAR2(1000),
   ORDER_FIELD_         CLOB,
   DS_ALIAS_            VARCHAR2(64),
   TABLE_               INTEGER,
   SQL_BUILD_TYPE_      VARCHAR2(20),
   SQL_                 CLOB,
   GRID_FIELD_          CLOB,
   DRILL_DOWN_KEY_      VARCHAR2(128),
   DRILL_DOWN_FIELD_    CLOB,
   TREE_ID_             VARCHAR2(64),
   DATA_ZOOM_           VARCHAR2(20),
   THEME_               VARCHAR2(50),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_ECHARTS_CUSTOM PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_ECHARTS_CUSTOM IS
'自定义Echarts图形报表';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.ID_ IS
'主键';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.NAME_ IS
'名称';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.KEY_ IS
'标识名 租户中唯一';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.ECHARTS_TYPE_ IS
'图表类型';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.TITLE_FIELD_ IS
'title字段定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.LEGEND_FIELD_ IS
'图例字段定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.XAXIS_FIELD_ IS
'x轴坐标定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.XAXIS_DATA_FIELD_ IS
'x轴data定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.XY_CONVERT_ IS
'x轴y轴转换';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.DATA_FIELD_ IS
'结果字段定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.SERIES_FIELD_ IS
'系列列表字段定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.DETAIL_METHOD_ IS
'数据的使用方式 - 为饼图配置';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.WHERE_FIELD_ IS
'条件字段定义';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.ORDER_FIELD_ IS
'排序字段';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.DS_ALIAS_ IS
'数据源名称';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.TABLE_ IS
'是否为表(1,表,0视图)';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.SQL_BUILD_TYPE_ IS
'SQL构建类型';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.SQL_ IS
'SQL';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.GRID_FIELD_ IS
'表格字段';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.DRILL_DOWN_KEY_ IS
'下钻字段Key';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.DRILL_DOWN_FIELD_ IS
'下钻字段字段';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.TREE_ID_ IS
'分类ID';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.DATA_ZOOM_ IS
'缩放区域';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.THEME_ IS
'主题';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.TENANT_ID_ IS
'租用用户Id';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN SYS_ECHARTS_CUSTOM.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_ECHARTS_PREMISSION  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_ECHARTS_PREMISSION PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_ECHARTS_PREMISSION IS
'图形报表树权限表';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.ID_ IS
'ID';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.TREE_ID_ IS
'树ID';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.TYPE_ IS
'类型';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.OWNER_ID_ IS
'用户或组ID';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.OWNER_NAME_ IS
'用户名或组名';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.TENANT_ID_ IS
'租用用户Id';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN SYS_ECHARTS_PREMISSION.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_ES_LIST  (
   ...
   QUERY_TYPE_          INTEGER,
   ES_TABLE_            VARCHAR2(64),
   QUERY_               VARCHAR2(1000),
   RETURN_FIELDS_       VARCHAR2(2000),
   CONDITION_FIELDS_    VARCHAR2(1000),
   SORT_FIELDS_         VARCHAR2(200),
   IS_PAGE_             INTEGER,
   LIST_HTML_           CLOB,
   TREE_ID_             VARCHAR2(64),
   TENANT_ID_           VARCHAR2(64),
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_ES_LIST PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_ES_LIST IS
'ES自定义列表';

COMMENT ON COLUMN SYS_ES_LIST.ID_ IS
'主键';

COMMENT ON COLUMN SYS_ES_LIST.NAME_ IS
'名称';

COMMENT ON COLUMN SYS_ES_LIST.ALIAS_ IS
'别名';

COMMENT ON COLUMN SYS_ES_LIST.ID_FIELD_ IS
'主键字段';

COMMENT ON COLUMN SYS_ES_LIST.QUERY_TYPE_ IS
'查询类型';

COMMENT ON COLUMN SYS_ES_LIST.ES_TABLE_ IS
'ES表名';

COMMENT ON COLUMN SYS_ES_LIST.QUERY_ IS
'查询语句';

COMMENT ON COLUMN SYS_ES_LIST.RETURN_FIELDS_ IS
'返回字段';

COMMENT ON COLUMN SYS_ES_LIST.CONDITION_FIELDS_ IS
'条件字段';

COMMENT ON COLUMN SYS_ES_LIST.SORT_FIELDS_ IS
'排序字段';

COMMENT ON COLUMN SYS_ES_LIST.IS_PAGE_ IS
'是否分页';

COMMENT ON COLUMN SYS_ES_LIST.LIST_HTML_ IS
'列表HTML';

COMMENT ON COLUMN SYS_ES_LIST.TREE_ID_ IS
'分类ID';

COMMENT ON COLUMN SYS_ES_LIST.TENANT_ID_ IS
'租用用户Id';

COMMENT ON COLUMN SYS_ES_LIST.CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN SYS_ES_LIST.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_ES_LIST.UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN SYS_ES_LIST.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_ES_QUERY  (
   ...
   NAME_                VARCHAR2(100),
   ALIAS_               VARCHAR2(64),
   QUERY_TYPE_          VARCHAR2(20),
   ES_TABLE_            VARCHAR2(64),
   QUERY_               VARCHAR2(1000),
   RETURN_FIELDS_       VARCHAR2(2000),
   CONDITION_FIELDS_    VARCHAR2(2000),
   SORT_FIELDS_         VARCHAR2(200),
   PAGE_SIZE_           INTEGER,
   NEED_PAGE_           INTEGER,
   TENANT_ID_           VARCHAR2(64),
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_ES_QUERY PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_ES_QUERY IS
' ES自定义查询';

COMMENT ON COLUMN SYS_ES_QUERY.ID_ IS
'主键';

COMMENT ON COLUMN SYS_ES_QUERY.NAME_ IS
'名称';

COMMENT ON COLUMN SYS_ES_QUERY.ALIAS_ IS
'别名';

COMMENT ON COLUMN SYS_ES_QUERY.QUERY_TYPE_ IS
'1,基于配置,2,编写SQL';

COMMENT ON COLUMN SYS_ES_QUERY.ES_TABLE_ IS
'索引';

COMMENT ON COLUMN SYS_ES_QUERY.QUERY_ IS
'查询语句';

COMMENT ON COLUMN SYS_ES_QUERY.RETURN_FIELDS_ IS
'定义返回字段';

COMMENT ON COLUMN SYS_ES_QUERY.CONDITION_FIELDS_ IS
'条件字段定义';

COMMENT ON COLUMN SYS_ES_QUERY.SORT_FIELDS_ IS
'排序字段';

COMMENT ON COLUMN SYS_ES_QUERY.PAGE_SIZE_ IS
'分页大小';

COMMENT ON COLUMN SYS_ES_QUERY.NEED_PAGE_ IS
'是否分页';

COMMENT ON COLUMN SYS_ES_QUERY.TENANT_ID_ IS
'租户管理';

COMMENT ON COLUMN SYS_ES_QUERY.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN SYS_ES_QUERY.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_ES_QUERY.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN SYS_ES_QUERY.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_EXCEL_TEMPLATE  (
   ...
   TEMPLATE_NAME_ALIAS_ VARCHAR2(64),
   TEMPLATE_TYPE_       VARCHAR2(64),
   TEMPLATE_COMMENT_    VARCHAR2(200),
   TEMPLATE_CONF_       CLOB,
   EXCEL_TEMPLATE_FILE_ VARCHAR2(64),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
...
COMMENT ON TABLE SYS_EXCEL_TEMPLATE IS
'EXCEL 导入模版';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.ID_ IS
'主键';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.TEMPLATE_NAME_ IS
'模版名称';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.TEMPLATE_NAME_ALIAS_ IS
'模版别名';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.TEMPLATE_TYPE_ IS
'模版类型';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.TEMPLATE_COMMENT_ IS
'备注';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.TEMPLATE_CONF_ IS
'配置';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.EXCEL_TEMPLATE_FILE_ IS
'EXCEL文件';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.TENANT_ID_ IS
'租户';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN SYS_EXCEL_TEMPLATE.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_FORMULA_MAPPING  (
   ID_                  VARCHAR2(64)                    NOT NULL,
   FORM_SOL_ID_         VARCHAR2(64),
   FORMULA_NAME_        VARCHAR2(200),
   FORMULA_ID_          VARCHAR2(64),
   BO_DEF_ID_           VARCHAR2(64),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_SYS_FORMULA_MAPPING PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_FORMULA_MAPPING IS
'表单方案公式映射';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.ID_ IS
'主键';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.FORM_SOL_ID_ IS
'表单方案ID';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.FORMULA_NAME_ IS
'公式名称';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.FORMULA_ID_ IS
'公式ID';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.BO_DEF_ID_ IS
'BO定义';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN SYS_FORMULA_MAPPING.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE SYS_INST  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   LAST_UPDATE_TIME_    INTEGER,
   "ID_SN_"             INTEGER,
   COMP_ID_             VARCHAR2(64),
...
COMMENT ON COLUMN SYS_INST."HOME_URL_" IS
'首页URL';
...
COMMENT ON COLUMN SYS_INST.LAST_UPDATE_TIME_ IS
'消息推送时间';

COMMENT ON COLUMN SYS_INST."ID_SN_" IS
'ID序号';

COMMENT ON COLUMN SYS_INST.COMP_ID_ IS
'公司ID';
...
COMMENT ON COLUMN SYS_INVOKE_SCRIPT.CATEGROY_ID_ IS
'分类ID';
...
CREATE TABLE SYS_NATION_AREA  (
   ID_                  VARCHAR2(64)                    NOT NULL,
   NATION_              VARCHAR2(10)                    NOT NULL,
   AREA_CODE_           VARCHAR2(20)                    NOT NULL,
   AREA_NAME_           VARCHAR2(100)                   NOT NULL,
   AREA_NAME_PY_        VARCHAR2(200),
   AREA_LEVEL_          SMALLINT                        NOT NULL,
   PROVINCE_            VARCHAR2(100)                   NOT NULL,
   CITY_                VARCHAR2(100),
   COUNTY_              VARCHAR2(100),
   RANK_                INTEGER                         NOT NULL,
   STATUS_              SMALLINT                        NOT NULL,
   PARENT_CODE_         VARCHAR2(64)                    NOT NULL,
   CONSTRAINT PK_SYS_NATION_AREA PRIMARY KEY (ID_)
);

COMMENT ON TABLE SYS_NATION_AREA IS
'地区表';

COMMENT ON COLUMN SYS_NATION_AREA.NATION_ IS
'国家简称';

COMMENT ON COLUMN SYS_NATION_AREA.AREA_CODE_ IS
'地区代码';

COMMENT ON COLUMN SYS_NATION_AREA.AREA_NAME_ IS
'地区名称';

COMMENT ON COLUMN SYS_NATION_AREA.AREA_NAME_PY_ IS
'地区名称拼音';

COMMENT ON COLUMN SYS_NATION_AREA.AREA_LEVEL_ IS
'地区级别';

COMMENT ON COLUMN SYS_NATION_AREA.PROVINCE_ IS
'省份';

COMMENT ON COLUMN SYS_NATION_AREA.CITY_ IS
'城市';

COMMENT ON COLUMN SYS_NATION_AREA.COUNTY_ IS
'县级';

COMMENT ON COLUMN SYS_NATION_AREA.RANK_ IS
'排序，值越大越前';

COMMENT ON COLUMN SYS_NATION_AREA.STATUS_ IS
'状态，[1:显示, 2:隐藏]';

COMMENT ON COLUMN SYS_NATION_AREA.PARENT_CODE_ IS
'所属地区';
...
CREATE TABLE SYS_SCRIPT_LIBARY  (
   ...
   TREE_ID_             VARCHAR2(64),
   FULL_CLASS_NAME_     VARCHAR2(64),
   METHOD_              VARCHAR2(64),
   PARAMS_              VARCHAR2(1000),
   RETURN_TYPE_         VARCHAR2(1000),
   DOS_                 VARCHAR2(512),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   BEAN_NAME_           VARCHAR2(64),
   EXAMPLE_             VARCHAR2(1000),
   CONSTRAINT PK_SYS_SCRIPT_LIBARY PRIMARY KEY (LIB_ID_)
);

COMMENT ON TABLE SYS_SCRIPT_LIBARY IS
'脚本定义';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.LIB_ID_ IS
'脚本id';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.TREE_ID_ IS
'分类ID';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.FULL_CLASS_NAME_ IS
'脚本全名';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.METHOD_ IS
'方法名：别名';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.PARAMS_ IS
'参数：类型为json json{}';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.RETURN_TYPE_ IS
'返回类型：java class type';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.DOS_ IS
'说明方法的详细使用';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.UPDATE_TIME_ IS
'更新时间';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.BEAN_NAME_ IS
'类名称';

COMMENT ON COLUMN SYS_SCRIPT_LIBARY.EXAMPLE_ IS
'调用脚本';
...
COMMENT ON COLUMN SYS_SUBSYS.TYPE_ IS
'类型
内部
外部';

COMMENT ON COLUMN SYS_SUBSYS.SECRET_ IS
'访问密钥';
...
COMMENT ON COLUMN SYS_TREE.BIND_SOL_ID_ IS
'分类绑定流程ID';
...
CREATE TABLE WX_MOBILE_PORTAL  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   BTN_TYPE_            VARCHAR2(64),
   CONSTRAINT PK_WX_MOBILE_PORTAL PRIMARY KEY (ID_),
   CONSTRAINT TYPE_ID_ UNIQUE (TYPE_ID_)
);

COMMENT ON TABLE WX_MOBILE_PORTAL IS
'手机门户类别表';

COMMENT ON COLUMN WX_MOBILE_PORTAL.NAME_ IS
'手机门户类别名称';

COMMENT ON COLUMN WX_MOBILE_PORTAL.TYPE_ID_ IS
'手机门户类别ID';

COMMENT ON COLUMN WX_MOBILE_PORTAL.TENANT_ID_ IS
'租用用户Id';

COMMENT ON COLUMN WX_MOBILE_PORTAL.CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN WX_MOBILE_PORTAL.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN WX_MOBILE_PORTAL.UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN WX_MOBILE_PORTAL.UPDATE_TIME_ IS
'更新时间';

COMMENT ON COLUMN WX_MOBILE_PORTAL.BTN_TYPE_ IS
'应用类型';
...
CREATE TABLE WX_MOBILE_PORTAL_BUTTON  (
   ...
   TYPE_ID_             VARCHAR2(64),
   SN_                  INTEGER,
   APP_TYPE_            VARCHAR2(32),
   PORT_ALIAS_          VARCHAR2(32),
   TENANT_ID_           VARCHAR2(64),
   CREATE_BY_           VARCHAR2(64),
   CREATE_TIME_         TIMESTAMP,
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_WX_MOBILE_PORTAL_BUTTON PRIMARY KEY (ID_),
   CONSTRAINT KEY_ UNIQUE (KEY_)
);

COMMENT ON TABLE WX_MOBILE_PORTAL_BUTTON IS
'手机门户类别按钮表';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.KEY_ IS
'键值';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.NAME_ IS
'按钮名称';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.APP_ID_ IS
'应用ID';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.ICON_ IS
'按钮图标';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.URL_ IS
'按钮URL地址';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.TYPE_ID_ IS
'按钮所属类别ID';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.SN_ IS
'序号';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.APP_TYPE_ IS
'应用类型';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.PORT_ALIAS_ IS
'入口别名';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.CREATE_BY_ IS
'创建人';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.UPDATE_BY_ IS
'更新人';

COMMENT ON COLUMN WX_MOBILE_PORTAL_BUTTON.UPDATE_TIME_ IS
'更新时间';
...
CREATE TABLE "BPM_HTTP_INVOKE_RESULT"  (
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_BPM_HTTP_INVOKE_RESULT PRIMARY KEY (ID_)
);

COMMENT ON TABLE "BPM_HTTP_INVOKE_RESULT" IS
'调用结果';
...
CREATE TABLE "BPM_HTTP_TASK"  (
   ID_                  VARCHAR2(64)                    NOT NULL,
   KEY_                 VARCHAR2(64),
   PARAMS_DATA_         VARCHAR2(2000),
   PARAMS_              BLOB,
   INVOKE_TIMES_        INTEGER,
   PERIOD_              INTEGER,
   RESULT_              INTEGER,
   TIMES_               INTEGER,
   FINISH_              INTEGER,
   ...
   UPDATE_BY_           VARCHAR2(64),
   UPDATE_TIME_         TIMESTAMP,
   CONSTRAINT PK_BPM_HTTP_TASK PRIMARY KEY (ID_)
);

COMMENT ON TABLE "BPM_HTTP_TASK" IS
'HTTP调用';

COMMENT ON COLUMN "BPM_HTTP_TASK".ID_ IS
'主键';

COMMENT ON COLUMN "BPM_HTTP_TASK".KEY_ IS
'服务名称';

COMMENT ON COLUMN "BPM_HTTP_TASK".PARAMS_DATA_ IS
'参数定义';

COMMENT ON COLUMN "BPM_HTTP_TASK".PARAMS_ IS
'变量';

COMMENT ON COLUMN "BPM_HTTP_TASK".INVOKE_TIMES_ IS
'调用次数';

COMMENT ON COLUMN "BPM_HTTP_TASK".PERIOD_ IS
'调用间隔';

COMMENT ON COLUMN "BPM_HTTP_TASK".RESULT_ IS
'调用结果';

COMMENT ON COLUMN "BPM_HTTP_TASK".TIMES_ IS
'实际调用次数';

COMMENT ON COLUMN "BPM_HTTP_TASK".FINISH_ IS
'是否完成';

COMMENT ON COLUMN "BPM_HTTP_TASK".SCRIPT_ IS
'脚本';

COMMENT ON COLUMN "BPM_HTTP_TASK".TENANT_ID_ IS
'租户ID';

COMMENT ON COLUMN "BPM_HTTP_TASK".CREATE_BY_ IS
'创建人ID';

COMMENT ON COLUMN "BPM_HTTP_TASK".CREATE_TIME_ IS
'创建时间';

COMMENT ON COLUMN "BPM_HTTP_TASK".UPDATE_BY_ IS
'更新人ID';

COMMENT ON COLUMN "BPM_HTTP_TASK".UPDATE_TIME_ IS
'更新时间';
