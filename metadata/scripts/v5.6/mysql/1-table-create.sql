...
(
   ...
   START_TIME_          DATE NOT NULL COMMENT '开始时间',
   END_TIME_            DATE NOT NULL COMMENT '结束时间',
...
(
   ...
   SEND_DATE_           DATE NOT NULL COMMENT '发送日期',
...
(
   ...
   IS_SYS_              VARCHAR(4) COMMENT '是否系统预设',
   STATUS_              VARCHAR(4) COMMENT '状态',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人',
...
ALTER TABLE INS_COLUMN_TEMP COMMENT '栏目模板管理表';
...
(
   ...
   START_TIME_          DATE NOT NULL COMMENT '有效开始时间',
   END_TIME_            DATE NOT NULL COMMENT '有效结束时间',
...
(
   ...
   START_               DATE NOT NULL COMMENT '开始时间',
   END_                 DATE NOT NULL COMMENT '结束时间',
...
(
   ...
   START_TIME_          DATE NOT NULL COMMENT '起始时间',
   END_TIME_            DATE NOT NULL COMMENT '终止时间',
...
(
   ...
   PSTART_TIME_         DATE NOT NULL COMMENT '计划开始时间',
