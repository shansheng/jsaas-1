...
import ${domain}.${system}.${subPackage}.dao.${subClass}Dao;
</#list>
...
public class ${class}Manager extends MybatisBaseManager<${class}>{
	...
	@Resource
	private ${subClass}Dao ${subClassVar}Dao;
	</#list>
	...
	public ${class} get${class}(String uId){
		...
		<#assign subClass=subTable.variables.class>
		<#assign subClassVar=subTable.variables.classVar>
		List<${subClass}> ${subClassVar}s= ${subClassVar}Dao.getByMain(uId);
	...
	public void update(${class} entity) {
		...
		${subClassVar}Dao.delByMainId(entity.getId());
