...
(
   ...
   OP_TYPE_             VARCHAR(50) NOT NULL COMMENT '操作类型',
   OP_CONTENT_          VARCHAR(512) NOT NULL COMMENT '操作内容',
   OVERTIME_            INT(11) COMMENT '超时时间',
   STATUS_              VARCHAR(64) COMMENT '节点状态',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人',
...
(
   ...
   TREE_ID_             VARCHAR(64) COMMENT '分类ID',
   GROUP_IDS_           VARCHAR(512) COMMENT '组IDS',
   USER_IDS_            VARCHAR(512) COMMENT '用户IDS',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人',
...
ALTER TABLE BPM_SOL_TEMPLATE_RIGHT COMMENT '流程模板分类权限';
...
(
   ...
   TEMPLET_             VARCHAR(6000) COMMENT '模板',
   ...
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   NEW_TYPE_            VARCHAR(30) COMMENT '新闻类型',
...
(
   ...
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人ID',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   IS_MOBILE_PORTAL_    VARCHAR(64) COMMENT '是否手机门户',
...
(
   ...
   TREE_ID_             VARCHAR(64) COMMENT '分类ID',
   FULL_CLASS_NAME_     VARCHAR(64) COMMENT '脚本全名',
   METHOD_              VARCHAR(64) COMMENT '方法名：别名',
   PARAMS_              VARCHAR(1000) COMMENT '参数：类型为json json{}',
   RETURN_TYPE_         VARCHAR(1000) COMMENT '返回类型：java class type',
   DOS_                 VARCHAR(512) COMMENT '说明方法的详细使用',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   BEAN_NAME_           VARCHAR(64) COMMENT '类名称',
   EXAMPLE_             VARCHAR(1000) COMMENT '调用脚本',
   PRIMARY KEY (LIB_ID_)
);
...
(
   ...
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人ID',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   BIND_SOL_ID_         VARCHAR(64) COMMENT '分类绑定流程ID',
...
(
   ID_                  VARCHAR(64) NOT NULL,
   NAME_                VARCHAR(64) COMMENT '手机门户类别名称',
   TYPE_ID_             VARCHAR(64) COMMENT '手机门户类别ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人ID',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人ID',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   BTN_TYPE_            VARCHAR(64) COMMENT '应用类型',
   PRIMARY KEY (ID_),
   UNIQUE KEY TYPE_ID_ (TYPE_ID_)
);

ALTER TABLE WX_MOBILE_PORTAL COMMENT '手机门户类别表';
...
(
   ID_                  VARCHAR(64) NOT NULL,
   KEY_                 VARCHAR(64) COMMENT '键值',
   NAME_                VARCHAR(64) COMMENT '按钮名称',
   APP_ID_              VARCHAR(64) COMMENT '应用ID',
   ICON_                VARCHAR(200) COMMENT '按钮图标',
   URL_                 VARCHAR(2000) COMMENT '按钮URL地址',
   TYPE_ID_             VARCHAR(64) COMMENT '按钮所属类别ID',
   SN_                  INT COMMENT '序号',
   APP_TYPE_            VARCHAR(32) COMMENT '应用类型',
   PORT_ALIAS_          VARCHAR(32) COMMENT '入口别名',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_BY_           VARCHAR(64) COMMENT '创建人',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   UPDATE_BY_           VARCHAR(64) COMMENT '更新人',
...
ALTER TABLE WX_MOBILE_PORTAL_BUTTON COMMENT '手机门户类别按钮表';
