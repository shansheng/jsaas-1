			...
			<form id="searchForm" class="search-form" >						
				<ul>
					...
					<#if (col.colType=="java.util.Date")>
						<li>
							<span class="text">${col.comment} 从</span>:<input  name="Q_${col.columnName}_D_GE"  class="mini-datepicker" format="yyyy-MM-dd" style="width:100px"/>
						</li>
						<li>
							<span class="text-to">至: </span><input  name="Q_${col.columnName}_D_LE" class="mini-datepicker" format="yyyy-MM-dd" style="width:100px" />
						</li>
					<#else>
						<li><span class="text">${col.comment}:</span><input class="mini-textbox" name="Q_${col.columnName}_S_LK"></li>
					</#if>
					</#if>
					</#list>
				</ul>
