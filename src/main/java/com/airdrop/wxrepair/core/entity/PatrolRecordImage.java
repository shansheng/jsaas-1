 ...
 * </pre>
 */
@TableDefine(title = "巡检图片上传")
public class PatrolRecordImage extends BaseTenantEntity {
	...
	public PatrolRecordImage() {
	}

	/**
	 * Default Key Fields Constructor for class Orders
	 */
	public PatrolRecordImage(String in_id) {
		this.setPkId(in_id);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof PatrolRecordImage)) {
			return false;
		}
		PatrolRecordImage rhs = (PatrolRecordImage) object;
