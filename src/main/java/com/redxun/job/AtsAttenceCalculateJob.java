...
public class AtsAttenceCalculateJob extends BaseJob {
	...
	public void executeJob(JobExecutionContext context) {
		try {
	        ...
	        //录入这个月的考勤
			model.setStartDate(DateUtil.add(new Date(), Calendar.DATE, DateUtil.daysBetween(new Date(), c.getTime())));
			model.setEndDate(DateUtil.add(new Date(), Calendar.DATE, DateUtil.daysBetween(new Date(), ca.getTime())));
