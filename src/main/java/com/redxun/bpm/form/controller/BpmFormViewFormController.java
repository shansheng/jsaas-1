...
public class BpmFormViewFormController extends BaseFormController {
    ...
    public JsonResult save(HttpServletRequest request, @ModelAttribute("bpmFormView") @Valid BpmFormView bpmFormView, BindingResult result) throws Exception {
        ...
        String template=bpmFormViewManager.convertToFreemakTemplate(bpmFormView.getTemplateView());
        ...
        sysCustomFormSettingManager.saveDefault(bpmFormView);
