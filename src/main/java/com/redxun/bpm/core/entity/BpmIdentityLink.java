 ...
 * 作者：ray
 * 邮箱: ray@redxun.com
 * 日期:2019-01-14 11:57:17
 * 版权：广州红迅软件
 * </pre>
 */
@TableDefine(title = "ACT_RU_IDENTITYLINK")
public class BpmIdentityLink extends BaseTenantEntity {
	...
	public BpmIdentityLink() {
	}

	/**
	 * Default Key Fields Constructor for class Orders
	 */
	public BpmIdentityLink(String in_id) {
		this.setPkId(in_id);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof BpmIdentityLink)) {
			return false;
		}
		BpmIdentityLink rhs = (BpmIdentityLink) object;
