...
public class InfInboxDao extends BaseJpaDao<InfInbox> {
    ...
    public List<InfInbox> getInboxBySender(String sender,String senderId,QueryFilter queryFilter){
    	...
    	String ql = "select box ,box.infInnerMsg.content as content from InfInbox box  "
    			+ "where box.infInnerMsg.sender = ? and box.infInnerMsg.senderId = ? and box.recType = 'REC'";
    	params.add(sender);
    	params.add(senderId);
    	...
    	System.err.println("sql : " + ql);
    	System.err.println(sender + " : " + senderId);
