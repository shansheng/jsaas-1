...
public class WxMeterialController extends MybatisListController{
    @Resource
	...
	public JSONObject submitMeterial(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		String mediaId=RequestUtil.getString(request, "mediaId");//媒体id,若是更新操作则会有媒体ID
		String tenantId=ContextUtil.getCurrentTenantId();
