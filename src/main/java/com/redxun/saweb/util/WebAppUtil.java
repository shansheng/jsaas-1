...
public class WebAppUtil implements ApplicationContextAware {
    ...
    protected static Logger logger=LogManager.getLogger(WebAppUtil.class);
     ...
     * @return
     */
     public static boolean isSaasMgrTenant(ITenant tenant){
     	if(tenant==null) return false;
     	return (getOrgMgrDomain().equals(tenant.getDomain()));
     }
