...
public class SysTreeManager extends BaseManager<SysTree>{
	...
	public SysTree getByKeyNotCurrent(String treeId, String key,String catKey,String tenantId) {
		SysTree sysTree = sysTreeDao.getByKeyNotCurrent(treeId,key, catKey, tenantId);
		if(sysTree == null) {
			return sysTreeDao.getByKeyNotCurrent(treeId,key, catKey, ITenant.ADMIN_TENANT_ID);
		}
		return sysTree;
	}
	
	public boolean isKeyExistInCatNotCurrent(String treeId, String key,String catKey,String tenantId) {
		SysTree sysTree = sysTreeDao.getByKeyNotCurrent(treeId,key, catKey, tenantId);
		return sysTree==null?false:true;
	}
	...
	public List<SysTree> getPersonFileTree(String userId){
	 ...
	 /**
	    ...
	    public List<SysTree> getByTreeIdNameCatKey(String tenantId,String path,String catKey){
	    	return sysTreeDao.getByTreeIdNameCatKey(tenantId, path, catKey);
	    }
	    ...
	    public List<SysTree> getByPath(String path){
	    	return sysTreeDao.getByPath(path);
	    }
	...
	public List<SysTree> getByAttributeValueTargetId(String userId) {
		return sysTreeDao.getByAttributeValueTargetId(userId);
	}
