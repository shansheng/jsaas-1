...
@Repository
public class SysSeqIdDao extends BaseMybatisDao<SysSeqId> {
	...
	public SysSeqId getByAliasForUpd(String alias,String tenantId){
		...
		params.put("alias", alias);
		params.put("tenantId", tenantId);
		SysSeqId seqId=this.getUnique("getByAliasForUpd", params);
    	
    	if(seqId!=null){
    		return seqId;
    	}else{
    		params.put("tenantId", ITenant.ADMIN_TENANT_ID);
    		return (SysSeqId)this.getUnique("getByAliasForUpd", params);
    	}
	}
