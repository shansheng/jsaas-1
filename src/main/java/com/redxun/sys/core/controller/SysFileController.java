...
public class SysFileController extends BaseController{
    ...
    public JsonResult del(HttpServletRequest request,HttpServletResponse response) throws Exception{
        ...
        if(file.exists()){
            ...
            sysFileManager.delete(fileId);
            return new JsonResult(true,"文件不存在！");
        }
    ...
    public JsonResult delImageFile(HttpServletRequest request,HttpServletResponse response) throws Exception{
    	...
    	String fullPath=null;
    	 ...
    	 if(sysFile==null){
    	     return new JsonResult(false,"文件已经不存在！");
         }
    	if(sysFile.getFrom()!=null && SysFile.FROM_APP.equals(sysFile.getFrom())){
    ...
    public ModelAndView appImages(HttpServletRequest request,HttpServletResponse response) throws Exception{
    	...
    	List<SysFile> imageFiles=sysFileManager.getImagesByFrom(from, ContextUtil.getCurrentUserId(),fileName,page);
    	
    	return this.getPathView(request).addObject("imageFiles",imageFiles).addObject("page",page)
    			.addObject("single",single).addObject("from",from).addObject("fileName",fileName);
    }
