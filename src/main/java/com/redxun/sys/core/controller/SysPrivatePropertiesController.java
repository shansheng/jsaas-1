...
public class SysPrivatePropertiesController extends MybatisListController{
    @Resource
	...
	public JsonPageResult<SysPrivateProperties> getPrivateProperties(HttpServletRequest request,HttpServletResponse response){
		...
		for (SysProperties commonProperties : sysProperties) {
			...
			SysPrivateProperties spp=sysPrivatePropertiesManager.getByProId(originId,tenantId);//获取该租户的这个公有参数对应的私有参数
			if(spp==null){
