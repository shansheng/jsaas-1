...
public class SysInst extends BaseEntity implements ITenant {
	...
	@Column(name = "ID_SN_")
	protected Integer idSn;
	
	@FieldDefine(title = "公司Id", defaultCol = MBoolean.YES)
	...
	@FieldDefine(title = "多机构状态", defaultCol = MBoolean.YES)
	@Column(name = "MORE_INST_STATUS_")
	protected String moreInstStatus;

	@FieldDefine(title = "申请加入处理备注", defaultCol = MBoolean.YES)
	@Column(name = "MORE_INST_NOTE_")
	protected String moreInstNote;

	@FieldDefine(title = "账号创建类型", defaultCol = MBoolean.YES)
	@Column(name = "MORE_INST_CTEATE_TYPE")
	protected String moreInstCreateType;

	@FieldDefine(title = "是否当前登陆机构", defaultCol = MBoolean.YES)
	protected boolean isPresent;

	public String getMoreInstNote() {
		return moreInstNote;
	}

	public void setMoreInstNote(String moreInstNote) {
		this.moreInstNote = moreInstNote;
	}

	public String getMoreInstCreateType() {
		return moreInstCreateType;
	}

	public void setMoreInstCreateType(String moreInstCreateType) {
		this.moreInstCreateType = moreInstCreateType;
	}
	...
	public String getMoreInstStatus() {
		return moreInstStatus;
	}

	public void setMoreInstStatus(String moreInstStatus) {
		this.moreInstStatus = moreInstStatus;
	}
