...
public class SysMenu extends BaseTenantEntity{
	...
	@Column(name = "MOBILE_ICON_CLS_")
	@Size(max = 32)
	protected String mobileIconCls;
	@Column(name = "IMG_")
	@Size(max = 50)
...
//	
	...
	public String getMobileIconCls() {
		return mobileIconCls;
	}

	public void setMobileIconCls(String mobileIconCls) {
		this.mobileIconCls = mobileIconCls;
	}
