...
public class SysBoList extends BaseTenantEntity {
	...
	@FieldDefine(title = "是否初始化数据")
	@Column(name = "IS_INIT_DATA_")
	protected String isInitData;
	...
	@FieldDefine(title = "绑定明细表单方案")
	@Column(name = "FORM_DETAIL_ALIAS_")
	protected String formDetailAlias="";
	...
	protected String formDetailName="";
	...
	public void setFormDetailName(String formDetailName) {
		this.formDetailName = formDetailName;
	}
	...
	public String getFormDetailAlias() {
		if(StringUtil.isEmpty(this.formDetailAlias)){
			return this.formAlias;
		}
		return formDetailAlias;
	}

	public void setFormDetailAlias(String formDetailAlias) {
		this.formDetailAlias = formDetailAlias;
	}
