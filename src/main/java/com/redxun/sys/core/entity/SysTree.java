...
public class SysTree extends BaseTenantEntity implements Tree{
	...
	/* 绑定流程ID */
	@FieldDefine(title="绑定流程ID")
	@Column(name = "BIND_SOL_ID_")
	protected String bindSolId;
	...
	@Transient
	private List<SysDic> sysDics = new ArrayList<SysDic>();
	...
	public String getBindSolId() {
		return bindSolId;
	}

	public void setBindSolId(String bindSolId) {
		this.bindSolId = bindSolId;
	}
	...
	public List<SysDic> getSysDics() {
		return sysDics;
	}

	public void setSysDics(List<SysDic> sysDics) {
