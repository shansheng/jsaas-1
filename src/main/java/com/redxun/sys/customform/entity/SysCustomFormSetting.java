...
public class SysCustomFormSetting extends BaseTenantEntity {
	...
	@FieldDefine(title = "表单JS")
	@Column(name = "CUSTOM_JS_SCRIPT_")
	protected String customJsScript="";
	...
	@FieldDefine(title = "不传入PK参数定义")
	@Column(name = "PARAM_DEF_")
	...
	public String getCustomJsScript() {
		return customJsScript;
	}

	public void setCustomJsScript(String customJsScript) {
		this.customJsScript = customJsScript;
	}
