...
@Repository
public class OsAttributeValueDao extends BaseMybatisDao<OsAttributeValue> {
	...
	public List<OsAttributeValue> getAttrByAttrIdAndValue(String attrId,String tenantId) {
		...
		return this.getBySqlKey("getAttrByAttrIdAndValue", map);
	}


	public void removeByTargetId(String targetId){
		this.getBySqlKey("removeByTargetId", targetId);
	}
}
