...
//    }
     ...
     * @return
     */
    public List<OsRelType> getRelTypesOfGroupUser(String dimId,String tenantId,Integer level){
    	return osRelTypeDao.getByDimId1RelType(dimId, OsRelType.REL_TYPE_GROUP_USER,tenantId,level);
    }
    /**
     * 获得该维度下的用户组间的关系类型定义
     * @param dimId
     ...
     * @return
     */
    public List<OsRelType> getRelTypesOfGroupGroup(String dimId,String tenantId,Integer level){
    	return osRelTypeDao.getByDimId1RelType(dimId, OsRelType.REL_TYPE_GROUP_GROUP,tenantId,level);
    }
     ...
     * @return
     */
    public List<OsRelType> getGroupUserRelations(String tenantId,String dimId){
    	return osRelTypeDao.getByRelTypeTenantIdIncludePublic(OsRelType.REL_TYPE_GROUP_USER, tenantId,dimId);
    }
    /**
     * 获得用户组间的关系类型列表
     * @return
