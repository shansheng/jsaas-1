 ...
 */
@Service
public class OsDimensionManager extends MybatisBaseManager<OsDimension>{
	@Resource
	private OsRankTypeDao osRankTypeDao;
	@Resource
	OsDimensionDao osDimensionDao;
	...
	public OsDimension getByDimIdTenantId(String dimId,String tenantId){
		return osDimensionDao.getByDimIdTenantId(dimId, tenantId);
	}
	...
	public List<OsDimension> filterateAll(String filterSwitch,String tenantId,QueryFilter queryFilter){
		...
		return osDimensionDao.filterateAll(queryFilter);
	}
