...
public class OsRankTypeManager extends BaseManager<OsRankType>{
    ...
    public OsRankType getByDimIdRankLevelTenantId(String dimId,Integer rankLevel,String tenantId){
    	return osRankTypeDao.getByDimIdRankLevelTenantId(dimId, rankLevel, tenantId);
    }
	...
	public List<OsRankType> getByMyDimIdTenantId(String dimId, String currentUserId, String currentTenantId) {
		return osRankTypeDao.getByMyDimIdTenantId(dimId, currentUserId, currentTenantId);
	}
}