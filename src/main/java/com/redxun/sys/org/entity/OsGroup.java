...
public class OsGroup extends BaseTenantEntity implements IGroup{
	 ...
	 * 用户组扩展属性
	 */
	public static final String OS_OGROUP_ATTR="osGroupAttributes";
	public static final String GROUPID="groupId";
	public static final String GROUP="Group";
	public static final String TENANTID="tenantId";
	public static final String PARENTID ="parentId";
	public static final String SYSINST ="sysInst";
	...
	@Transient
	protected String rankLevelName;
	/* 状态 */
	...
	public void setRankLevelName(String rankLevelName) {
		this.rankLevelName = rankLevelName;
	}
