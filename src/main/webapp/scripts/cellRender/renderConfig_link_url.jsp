...
<body>
	...
	<div class="mini-fit">
		<div class="form-container" id="miniForm">
		<table class="table-detail column_2_m" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td colspan="3">
					<input class="mini-buttonedit" id="cusQuery" name="cusQuery" allowInput="false" showClose="true" oncloseclick="_ClearButtonEdit" onbuttonclick="selectCustomQuery" style="width:250px;"/>
				</td>
			</tr>
			<tr>
				<th>绑定参数</th>
			...
			<tr>
				...
				<td> 
					...
					<a class="mini-button" onclick="appendReturnField">插入返回值</a>
				</td>
			</tr>
			<tr>
				<th>URL快捷方式</th>
