...
<body>
			...
			<form id="miniForm">
				<table class="table-detail column_2_m" cellspacing="1" cellpadding="1">
					...
					<tr id="vtype_Tr">
						<th>校验规则</th>
						<td >
							<input id="validrule" name="validrule" class="mini-combobox"  textField="name" valueField="value" 
					...
					<tr>
						<th>值  来  源</th>
						<td><input class="mini-combobox" name="from" id="from" required="true" data="[{'id':'forminput','text':'手动输入'},{'id':'sequence','text':'系统流水号'},{'id':'scripts','text':'脚本'}]" value="forminput" allowInput="false" onItemclick="fromHanlder(e)" /></td>
								...
								<div id="gridPanel" class="mini-panel" title="header"   style="width: 480px; height: 280px;" showToolbar="true" showCloseButton="true" showHeader="false" bodyStyle="padding:0" borderStyle="border:0">
									<div property="toolbar" style="padding: 5px; padding-left: 8px; text-align: center;">
										<div style="float: left; padding-bottom: 2px;">
											<span class="text">别名：</span><input id="keyText" class="mini-textbox" style="width: 160px;" onenter="onSearchClick" /> 
	...
	<script type="text/javascript">
		...
		window.setData=function(elContent){
			
		    if(elContent){
		    	oNode=$(elContent).get(0);
		        //获得字段名称
		        var formData={};
		        var vtypeName;
