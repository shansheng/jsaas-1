	...
	<div class="form-outer">
			<form id="miniForm">
				<table class="table-detail column-four" cellspacing="0" cellpadding="1">
					<tr>
						<td class="form-table-th">标题<span class="star">*</span></td>
						...
						<td class="form-table-th">字段名</td>
						<td class="form-table-td">
							<input id="name" class="mini-textbox" name="name" required="true" vtype="maxLength:100,chinese"
														 style="width: 100%" emptytext="请输入字段标识"  onvalidation="onEnglishAndNumberValidation"/>
						</td>
					</tr>
					<tr>
						
						<td>选择解决方案</td>
					<td><input id="solution" name="solution" class="mini-buttonedit"
							   onbuttonclick="chooseSolution" selectOnFocus="true" required="true" style="width: 100%;"/></td>
						<td>单选或多选</td>
