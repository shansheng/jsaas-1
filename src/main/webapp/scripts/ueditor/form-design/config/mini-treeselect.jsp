			...
			<form id="miniForm">
				...
				<table class="table-detail column-four" cellspacing="0" cellpadding="1">
					...
					<tr id="url_row" style="">
						<td >JSON URL</td>
						<td colspan="3">
							<input id="url" class="mini-textbox" name="url" required="true" style="width: 40%"/>
						文本字段:<input id="url_textfield" class="mini-textbox" name="url_textfield" style="width: 80px" required="true">&nbsp;-&nbsp;数值字段:<input id="url_valuefield" class="mini-textbox" name="url_valuefield" required="true" style="width: 80px">&nbsp;-&nbsp;父节点字段:<input id="url_parentfield"  class="mini-textbox" name="url_parentfield" required="true" style="width: 80px">
						</td>
					</tr>
					...
					<tr>
						<td>可以选择父节点</td>
						<td><input name="allowparentselect" class="mini-checkbox" id="allowparentselect" />是</td>
						<td>自动选择父节点</td>
					...
					<tr>
						...
						<td id="expand_settings_label" style="display: none;word-break: break-all;">展开设置</td>
 					...
 					<tr>
						...
						<td >
							...
							宽：<input id="popupwidth" name="popupwidth" class="mini-spinner" style="width:80px" value="200" minValue="0" maxValue="1200"/>
						...
						<td colspan="3">
							...
							<input id="wunit" name="wunit" class="mini-combobox" style="width: 50px"
								   ...
								   textField="text" valueField="id" value="px" required="true" allowInput="false" />
							</div>
							<div>
							高：<input id="mheight" name="mheight" class="mini-spinner" style="width: 80px" value="0"
							minValue="0" maxValue="1200" />
							<input id="hunit"
								   name="hunit" class="mini-combobox"
								   style="width: 50px"
								   onvaluechanged="changeMinMaxHeight" data="[{'id':'px','text':'px'},{'id':'%','text':'%'}]"
								   textField="text" valueField="id" value="px" required="true" allowInput="false" />
							</div>
						</td>
					</tr>
		...
		dialog.onok = function (){
		    ...
		    if( !oNode ) {
		        try {
		            ...
		            oNode.setAttribute('class','mini-treeselect treeSelect rxc');
            ...
            oNode.setAttribute('onbeforenodeselect','beforenodeselect');
            var options={};
            options.allowparentselect=formData.allowparentselect;
            oNode.setAttribute("data-options",JSON.stringify(options))
