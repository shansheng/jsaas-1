...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		...
		<div title="自定义查询配置" region="center"  showHeader="false" >
			<div id="toolbar1" class="form-toolBox" style="text-align: right">
				<a id="btnSave" class="mini-button"  plain="true" onclick="saveSetting()">保存</a>
    		</div>
			
			<table id="formSetting" class="table-detail column-four" cellspacing="1" cellpadding="0" style="width:100%;">
				<tr>
					<td>名　称</td>
					<td >
					...
					<td colspan="3" >
						<div id="gridInput" class="mini-datagrid"  showPager="false"
						 allowCellEdit="true" allowCellSelect="true" allowSortColumn="false"
						    ...
						    <div property="columns">
						        <div field="name" displayfield="comment"  headerAlign="center" allowSort="true" align="center">查询条件
