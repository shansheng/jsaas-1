						...
						<td colspan="3" style="padding:0;">
							...
							<div style="display:none">
								<input  property="editor"
									...
									valuefield="format"
			    				 	data="[{format:'yyyy-MM',formatName:'yyyy-MM'},{format:'yyyy-MM-dd',formatName:'yyyy-MM-dd'},{format:'yyyy-MM-dd HH:mm:ss',formatName:'yyyy-MM-dd HH:mm:ss'}]"  
			    				 	allowInput="false" 
			    				 	showNullItem="true" 
			    				 	nullItemText="请选择..."
		    				 	/>
						...
						<td colspan="3">
							...
							>
							    <div property="columns" class="border-right">
							        <div type="indexcolumn" width="20"></div>
							        <div type="checkcolumn" width="20"></div>
							        <div field="text" width="100" headerAlign="center">按钮名
							        	<input property="editor" class="mini-textbox" style="width:100%;" />
							        </div>              
							        <div field="onclick" width="100" headerAlign="center">方法名
							        	<input property="editor" class="mini-textbox" style="width:100%;" />
							        </div>
							    </div>
							</div>
