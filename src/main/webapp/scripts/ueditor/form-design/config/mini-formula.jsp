    				...
    				<tr>
    					<td style="width:30px">
    						<div class="div-helper" >
			    				<div  class="iconfont helper icon-Help-configure" title="帮助" placement="e" helpid="formulaHelp"></div>
			    			</div>
    					</td>
    					<td>
    						小数位精度:<input id="decimal" type="text" value="2" style="width:40px"/>		
    					</td>
    				</tr>
    			</table>
    			<textarea id="formula" style="width:98%;height:120px"></textarea>
  			</fieldset>
		</td>
	</tr>
</table>
