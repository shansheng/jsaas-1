...
<body>
	<rx:toolbar toolbarId="toolbar1" pkId="insPortalPermissionType.id" />
	<div id="p1" class="form-outer shadowBox90">
		<form id="form1" method="post">
		<div id="p1" class="form-outer shadowBox90">
		<form id="form1" method="post">
				<div class="form-inner">
				<input id="pkId" name="id" class="mini-hidden" value="${insPortalPermissionType.id}" />
				<input id="layoutId" name="layoutId" value="${layoutId}" class="mini-hidden"  />
				<table class="table-detail" cellspacing="1" cellpadding="0">
					<caption>编辑权限</caption>
					<tr>
						<th>类　　型</th>
						<td>
	...
	function onOk(){
        ...
        var config={
        	url:"${ctxPath}/filetray/authority/insPortalPermissionType/savePortal.do?type2="+type2+"&&type2Name="+encodeURI(encodeURI(type2Name)),
        	method:'POST',
        	data:formData,
