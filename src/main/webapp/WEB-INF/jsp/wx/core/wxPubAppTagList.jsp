...
<body>
         ...
         <table style="width:100%;">
             <tr>
                 <td style="width:100%;">
                     ...
                     <a class="mini-button btn-red" iconCls="icon-remove" plain="true" onclick="removeTags()">删除</a>
                     <a class="mini-button"   plain="true" onclick="searchTag()">查询</a>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			...
			<div property="columns">
				...
				<div name="action" cellCls="actionIcons" width="22" headerAlign="center" align="center" renderer="onActionRenderer" cellStyle="padding:0;">相关#</div>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			var record = e.record;
			var id = record.id;
			var s ='<span  title="编辑" onclick="editTag(\'' + id + '\',true)"></span>'
					+'<span  title="删除" onclick="removeTag(\'' + id + '\')"></span>';
			return s;
		}
