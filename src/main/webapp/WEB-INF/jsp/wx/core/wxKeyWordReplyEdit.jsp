				...
				<table class="table-detail column-two" cellspacing="1" cellpadding="0">
					...
					<tr class="replyType" >
								...
								<tr class="text" style="display: none;">
									<td>文本信息</td>
									<td>
									<textarea name="replyText" id="replyText" class="mini-textarea" emptyText="请输入文本" style="width: 90%;"></textarea>
									</td>
								</tr>
								...
								<tr class="music" style="display: none;">
									<td>音乐</td>
									<td>
									<input class="mini-textbox" name="replyMusic" id="replyMusic" emptyText="请输入音乐外链url" style="width: 90%;"/>
									</td>
								</tr>
							...
							<tr class="meterial" style="display: none;">
								...
								<input id="meterial"  class="mini-textboxlist" name="meterial" textName="meterialText" style="width: 90%;"
									allowInput="false" valueField="id" textField="text" required='true' /> <a class="mini-button" id="addMeterialButton"
									  plain="true" onclick="addMeterial">选择素材</a></td>
							</tr>
				</table>
			</div>
		</form>
