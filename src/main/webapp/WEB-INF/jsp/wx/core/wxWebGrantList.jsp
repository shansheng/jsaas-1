...
<body>
     ...
     <div class="mini-toolbar" >
     	...
     	<ul class="toolBtnBox">
     		<li>
     			<a class="mini-button" plain="true" onclick="addWebGrant()">增加</a>
     		</li>
     		<li>
	 ...
	 <div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			...
			<div property="columns">
				...
				<div name="action" cellCls="actionIcons" width="30" renderer="onActionRenderer" cellStyle="padding:0;">操作</div>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = '<span  title="明细" onclick="detailRow(\'' + pkId + '\')">明细</span>'
					+'<span  title="编辑" onclick="editMyRow(\'' + pkId + '\',true)">编辑</span>'
