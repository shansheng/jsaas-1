...
<body>
	<div class="topToolBar">
		<div>
	    <a class="mini-button"   id="sendButton" onclick="sendMsg()">发送</a>
				...
				<table class="table-detail column-two" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td><input id="receiver" class="mini-textboxlist" name="receiver" textName="receiverText" style="width: 80%; height: 80px;"
							allowInput="false" valueField="id" textField="text" required="true" /> <a class="mini-button" id="addButton"   plain="true"
					...
					<a class="mini-button" id="addMeterialButton"   plain="true"
