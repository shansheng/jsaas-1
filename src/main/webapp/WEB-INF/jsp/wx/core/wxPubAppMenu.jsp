...
<body>
 <div class="mini-toolbar" >
    <a class="mini-button"  plain="true" onclick="saveMenus(false)">保存</a>
    <a class="mini-button"  plain="true" onclick="saveMenus(true)">生成</a>
    <a class="mini-button"  plain="true" onclick="addMenu()">新增一级菜单</a>
    <a class="mini-button"  plain="true" onclick="addSubMenu()">新增子菜单</a>
    <a class="mini-button btn-red"  plain="true" onclick="deleteMenu()">删除</a>
     </div>
<div class="mini-fit">
			...
			<div class="form-inner">
							<table class="table-detail column-two" cellspacing="1" cellpadding="0">
								<tr class="menuType" style="display: none;">
									<td>菜单类型</td>
									<td><input id="menuType"  class="mini-combobox" style="width: 250px;" textField="text" valueField="id"
								...
								<tr class="viewUrl" style="display: none;">
									<td>填写url</td>
									<td><input id="menuView" name="menuView" class="mini-textbox" emptyText="请输入url"  width="250" onvaluechanged="changeView" />
									 <!-- <a class="mini-button"  plain="true" onclick="chooseUrl()">选择</a> --> 
									</td>
								</tr>
