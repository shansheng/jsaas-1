...
<div class="mini-fit">
<div id="layout1" class="form-container" style="width:100%;height:100%;">
		...
		<form id="form1" method="post">
			<div class="form-inner">
							<table class="table-detail column-two" cellspacing="1" cellpadding="0">
								<tr class="replyType" >
									<td>回复类型</td>
									<td><input id="replyType" name="replyType" class="mini-combobox" style="width: 400px;" textField="text" valueField="id"
