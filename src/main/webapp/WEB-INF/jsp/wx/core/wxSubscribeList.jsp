...
<body>
	...
	<div id="layout1" class="mini-layout" style="width:100%;height:100%;" >
    	...
    	>
		    <div property="toolbar" class="toolbar-margin">
				<a class="mini-button" onclick="addTag" plain="true" >添加标签</a>
			</div>
				...
				<table style="width:100%;">
					<tr>
		                 <td style="width:100%;">
		                     ...
		                     <a class="mini-button btn-red" iconCls="icon-remove" plain="true" onclick="alert(1);">删除</a>
			...
			<div class="mini-fit rx-grid-fit" style="height: 100%;">
				...
				>
					<div property="columns">
						...
						<div name="action" cellCls="actionIcons" width="22"  renderer="onActionRenderer" cellStyle="padding:0;">操作</div>
	...
	<ul id="treeMenu" class="mini-contextmenu" onbeforeopen="onBeforeOpen">
		<li name="subadd"  onclick="onEditNode">编辑标签</li>
		<li name="remove" class=" btn-red" onclick="onRemoveNode">删除标签</li>
	</ul>
