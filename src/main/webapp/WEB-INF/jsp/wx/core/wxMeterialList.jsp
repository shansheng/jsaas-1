...
<body>
	<div class="mini-toolbar" >
		...
		<ul class="toolBtnBox">
	   		<li>
	   			<a class="mini-button" plain="true" onclick="createMeterial()">新增素材</a>
			</li>
			<li>
				<a class="mini-button btn-red" plain="true" onclick="remove()">删除素材</a>
			</li>
			<li class="clearfix"></li>
		</ul>
