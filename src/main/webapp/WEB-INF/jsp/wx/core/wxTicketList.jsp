...
<body>
	 <div class="mini-toolbar" >
     	...
     	<ul class="toolBtnBox">
     		<li>
     			<a class="mini-button" plain="true" onclick="addTicket(true)">添加卡券</a>
     		</li>
     		<li>
     			<a class="mini-button btn-red" plain="true" onclick="remove()">删除</a>
     		</li>
     		<li>
     			<a class="mini-button" plain="true" onclick="createLandingPage()">创建货架</a>
     		</li>
     		<li>
     			<a class="mini-button" plain="true" onclick="consumeTicket()">核销卡券</a>
     		</li>
     		<li>
     			<a class="mini-button" plain="true" onclick="unVailableTicket()">废除卡券</a>
     		</li>
     		<li class="clearfix"></li>
     	</ul>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = '<span  title="明细" onclick="detailRow(\'' + pkId + '\')">明细</span>';
					s+='<span  title="编辑" onclick="editMyRow(\'' + pkId + '\',true)">编辑</span>';
					s+='<span  title="删除" onclick="delRow(\'' + pkId + '\')">删除</span>';
					s+='<span  title="查询领取详情" onclick="getRecInfo(\'' + pkId + '\')">查询领取详情</span>';
					s+='<span  title="投放" onclick="putInRow(\'' + pkId + '\')">投放</span>';
			return s;
		}
