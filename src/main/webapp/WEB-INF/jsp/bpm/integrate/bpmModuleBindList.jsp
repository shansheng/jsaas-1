...
<body>      
	<div class="mini-toolbar">
		<div class="searchBox">
			<form id="searchForm" class="search-form" >						
				...
				<div id="moreBox">
					<ul>
						<li>
							<span class="long text">流程解决方案Key：</span>
							<input class="mini-textbox" name="Q_solKey_S_LK"/>
						</li>
						<li>
							<span class="long text">流程解决方案名称：</span>
		...
		<ul class="toolBtnBox">
			<li>
				<a class="mini-button"   onclick="onAdd" >新增</a>
			</li>
			<li>
				<a class="mini-button"  onclick="onSaveCur">保存</a>
			</li>
		</ul>
