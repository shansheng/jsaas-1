	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" url="${ctxPath}/bpm/bm/bpmFormInst/listData.do" idField="formInstId" multiSelect="true" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" pageSize="20" allowAlternating="true" pagerButtons="#pagerButtons">
			<div property="columns">
				...
				<div field="subject" width="120"  allowSort="true">实例标题</div>
				<div field="instId" width="120"  allowSort="true">流程实例ID</div>
				<div field="actInstId" width="120"  allowSort="true">ACT实例ID</div>
				<div field="actDefId" width="120"  allowSort="true">ACT定义ID</div>
				<div field="defId" width="120"  allowSort="true">流程定义ID</div>
				<div field="solId" width="120"  allowSort="true">解决方案ID</div>
				<div field="fmId" width="120"  allowSort="true">数据模型ID</div>
				<div field="fmViewId" width="120"  allowSort="true">表单视图ID</div>
				<div field="status" width="120"  allowSort="true">状态</div>
				<div field="jsonData" width="120"  allowSort="true">数据JSON</div>
				<div field="isPersist" width="120"  allowSort="true">是否持久化</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
	        ...
	        function onActionRenderer(e) {
	            ...
	            var s = '<span  title="明细" onclick="detailRow(\'' + uid + '\')">明细</span>'
	                    + ' <span  title="编辑" onclick="editRow(\'' + uid + '\')">编辑</span>'
