...
<body>
			...
			<div  name="boSetting">
				<div class="form-inner">
					<table class="table-detail column-two" cellspacing="1" cellpadding="0">
						...
						<tr>
							<td>取值类型</td>
							<td><input id="valType" name="valType" class="mini-combobox" style="width: 150px;padding: 0 2px" textField="text" valueField="id" data="data"
	...
	var data=[{ id: 'constant', text: '常量' },{ id: 'script', text: '脚本'},{ id: 'manual', text: '固定值'},{id: 'opinion', text: '审批意见'}];
