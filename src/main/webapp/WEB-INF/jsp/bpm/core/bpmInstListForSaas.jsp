		    ...
		    <div title="流程实例列表" region="center" showHeader="false" showCollapseButton="false">
						...
						<form id="searchForm" class="search-form" >						
							<ul>
								<li>
									...
									<input class="mini-buttonedit" allowInput="false" name="Q_CREATE_BY__S_EQ" onbuttonclick="selectUser"/>
								</li>
								<li>
								...
								<li class="liBtn">
									...
									<a class="mini-button _reset btn-red"  onclick="onClear()">清空</a>
							...
							<div id="moreBox">
								<ul>
									...
									<li>
										<span class="text">状态：</span><input class="mini-combobox"  name="Q_STATUS__S_EQ"
				...
				<div class="mini-fit rx-grid-fit" style="height: 100%;">
					<div 
						...
						style="width: 100%; height:100%;" 
						allowResize="false"
						url="${ctxPath}/bpm/core/bpmInst/listForSaasAdmin.do" 
						idField="instId" 
						multiSelect="true" 
					...
					>
						<div property="columns">
							...
							<div name="action" cellCls="actionIcons" width="100" renderer="onActionRenderer" cellStyle="padding:0;">#</div>
	...
	winHeight="450" winWidth="700" entityTitle="流程实例"
		...
		<script type="text/javascript">
			...
			function onClear(){
				...
				form.clear();
				grid.setUrl("${ctxPath}/bpm/core/bpmInst/listForSaasAdmin.do");
				grid.load();
			}
			...
			function onSearch(){
				...
				grid.setUrl("${ctxPath}/bpm/core/bpmInst/listForSaasAdmin.do?"+data);
				grid.load();
			}
	        ...
	        function onActionRenderer(e) {
        	 ...
        	 function getByJson(record,json){
        		...
        		switch(json.key){
        			case "del":
        				if(json.val){
        					str='  <span  title="删除" onclick="delRow(\'' + pkId + '\')"></span>';
        				}
        				break;
        			case "intervene":
	    	...
	    	function treeNodeClick(e){
		   		var node=e.node;
		   		grid.setUrl(__rootPath+'/bpm/core/bpmInst/listForSaasAdmin.do?treeId='+node.treeId);
		   		grid.load();
		   	}
        </script>
