...
<script type="text/javascript" src="${ctxPath}/scripts/flow/form/userTypeSelect.js?t=${__version}"></script>
</head>
<body>
		...
		<form id="form1">
			...
			<table class="table-detail column-four" cellspacing="1" cellpadding="0">
				<tr>
					<td width="140">名　　称</td>
					<td>
						<input name="groupName" value="${userGroup.groupName}" class="mini-textbox" vtype="maxLength:50" required="true" style="width: 90%" />
					</td>
					<td width="140">序　　号</td>
					<td>
				...
				<tr>
					...
					<td colspan="3">
						<textarea id="config_${userGroup.nodeId}" onfocus="conditionOnFocus"  class="mini-textarea" name="setting" style="width:80%;height:60px;" ><c:out escapeXml="true" value="${userGroup.setting}"/></textarea>
	    	...
	    	<div id="userGrid" class="mini-datagrid" oncellbeginedit="OnCellBeginEdit" style="width:100%;mini-height:300px;"
				...
				<div property="columns">
					...
					<div  field="isCal" name="isCal"  width="60" headerAlign="center" renderer="onCalcModeRender" >是否计算用户
	...
	function setName(name){
		mini.getByName("groupName").setValue(name);
	}
