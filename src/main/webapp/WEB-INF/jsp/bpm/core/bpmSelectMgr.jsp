...
<body>
			...
			<div class="mini-splitter" style="width: 100%; height: 100%;" borderStyle="border:0;">
				<div size="360" maxSize="500" minSize="100" showCollapseButton="true" style="border-width: 1px;">
					<div id="panel1" name="panel" class="mini-panel" title="模版分类" iconCls="icon-abstain" style="width: 100%; height: 100%;"
						...
						<ul id="tree1" class="mini-tree" url="${ctxPath}/sys/core/sysTree/listByCatKey.do?catKey=BPM_TEMPLATE_TREE" style="width: 100%; padding: 5px; height: 100%"
	...
	<ul id="treeMenu" class="mini-contextmenu" onbeforeopen="onBeforeOpen">
		<li name="subadd"   onclick="onAddNode">加入子分类</li>
		<li name="edit" onclick="onEditNode">编辑分类</li>
		<li name="remove"  class=" btn-red" onclick="onRemoveNode">删除分类</li>
	</ul>
