...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    ...
		    <div title="待办列表" region="center" showHeader="false" showCollapseButton="false">
				<div class="mini-toolbar" >
					...
					<ul class="toolBtnBox">
						...
						<li>
							<a class="mini-button"  plain="true" onclick="batchApproval">批量审批</a>
						</li>
					</ul>
	...
	<script type="text/javascript">
		   ...
		   function treeNodeClick(e){
		   		var node=e.node;
		   		grid.setUrl(__rootPath+'/bpm/core/bpmTask/myTasks.do?treeId='+node.treeId);
		   		grid.load();
		   	}
