...
<body>
			<div class="topToolBar" >
	            <div>
                 <a class="mini-button"   onclick="addRow()" plain="true" tooltip="增加...">增加变量</a>
                 <a class="mini-button"  onclick="saveRows()" plain="true">保存变量</a>  
                 <a class="mini-button btn-red"  onclick="delRows()" plain="true">删除</a>
                 <a class="mini-button"  onclick="refreshGrid()" plain="true">刷新</a>
