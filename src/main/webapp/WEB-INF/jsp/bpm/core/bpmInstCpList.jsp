        ...
        <div class="mini-fit" style="height:100%;">
            <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false"
                ...
                <div property="columns">
                    ...
                    <div field="userId" width="120" headerAlign="" allowSort="true">${column.remarks}</div>
                    <div field="groupId" width="120" headerAlign="" allowSort="true">${column.remarks}</div
                    <div field="ccId" width="120" headerAlign="" allowSort="true">${column.remarks}</div>
                    <div field="isRead" width="120" headerAlign="" allowSort="true">${column.remarks}</div></div>
            </div>
        </div>
