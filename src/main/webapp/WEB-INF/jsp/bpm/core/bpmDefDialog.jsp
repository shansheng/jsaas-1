				...
				<div class="searchBox">
					<form id="searchForm" class="search-form" >						
						<ul>
							...
							<li>
								<input class="mini-textbox" name="Q_subject__S_LK" emptyText="请输入标题"/>
							</li>
							<li>
								<input class="mini-textbox"  name="Q_key__S_LK" emptyText="请输入标识"/>
							</li>
							<li>
			...
			<div class="mini-fit">
				...
				>
					<div property="columns"  >
						...
						<div field="status"  width="80" renderer="onStatusRenderer" headerAlign="center">状态</div>
