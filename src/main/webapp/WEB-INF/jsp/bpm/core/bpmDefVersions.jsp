...
<body>
	        ...
	        <div class="mini-fit form-outer">
				...
				sizeList="[5,10,20,50,100,200,500]" pageSize="20" allowAlternating="true" >
					<div property="columns">
						...
						<div field="subject" width="140" headerAlign="" allowSort="true">名称</div>
						<div field="key" width="140" headerAlign="" allowSort="true">标识键</div>
						<div field="isMain" width="80" headerAlign="" allowSort="true" renderer="onIsMainRenderer">是否为主版本</div>
						<div field="version" width="80" headerAlign="" allowSort="true">版本号</div>
						<div field="status" width="60" headerAlign="" allowSort="true" renderer="onStatusRenderer">状态</div>
					</div>
				</div>
			</div>
        </div>
    ...
    function onActionRenderer(e) {
        ...
        var s = '<span  title="明细" onclick="detailRow(\'' + uid + '\')">明细</span>'
                ...
                + ' <span  title="设计" onclick="designRow(\'' + modelId + '\')">设计</span>'
