...
<body>
	<div class="mini-toolbar mini-toolbar-bottom">
		<a class="mini-button"   onclick="addTestCase()" plain="true">添加测试方案用例</a>
		<a class="mini-button btn-red" iconCls="icon-remove" plain="true" onclick="delTestCase()">删除测试方案用例</a>
	...
	<div id="caseWindow" class="mini-window" iconCls="icon-debug-white" title="添加测试用例" style="width:400px;height:150px;"
	    ...
	    <div property="footer" >
   			<a class="mini-button"   onclick="submitTestCase()">提交</a>
   			<a class="mini-button btn-red"   onclick="closeWin()">关闭</a>
	    </div>
	</div>
