					...
					<tr>
						<td>
							<div id="expOptions" name="expOptions" class="mini-checkboxlist" repeatItems="4" repeatLayout="table"
								data="[{id:'bpmSolution',text:'流程业务解决方案'},{id:'bpmDefExt',text:'流程定义'},{id:'bpmFormViews',text:'流程表单'},{id:'bpmSolFvs',text:'流程表单配置'},{id:'bpmNodeSets',text:'流程节点配置'},{id:'bpmSolVars',text:'流程节点变量配置'},{id:'bpmSolUsers',text:'流程审批人员配置'},{id:'formViewRights',text:'表单字段权限配置'},{id:'bpmJumpRule',text:'跳转规则'}]" >
							</div>
						</td>
					</tr>
