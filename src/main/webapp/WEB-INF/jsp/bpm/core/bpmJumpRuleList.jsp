...
<body>
	 <div class="topToolBar" >
     	<div style="text-align: left;">
			 <a class="mini-button"  plain="true" onclick="addRule()">增加</a>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			url="${ctxPath}/bpm/core/bpmJumpRule/listData.do?Q_ACTDEF_ID__S_EQ=${param.actDefId}&Q_SOL_ID__S_EQ=${param.solId}&Q_NODE_ID__S_EQ=${param.nodeId}" 
			idField="id" multiSelect="true" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" 
			pageSize="20" allowAlternating="true" showPager="false">
	...
	<redxun:gridScript gridId="datagrid1" entityName="com.redxun.bpm.core.entity.BpmJumpRule" winHeight="450"
		winWidth="800" entityTitle="流程跳转规则" baseUrl="bpm/core/bpmJumpRule" />
	...
	<script type="text/javascript">
		...
		function addRule(){
			...
			_OpenWindow({
				url: url,
		        title: "添加流程跳转规则", width: 800, height: 500,
