    ...
    <tr>
        <td>
            <div id="datagrid1" class="mini-datagrid" style="width: 100%;" height="auto" allowResize="false"
                 showPager="false"
                 url="${ctxPath}/bpm/core/bpmNodeJump/listForInst.do?actInstId=${actInstId}" idField="jumpId"
                ...
                <div property="columns">
                    ...
                    <div field="completeTime" dateFormat="yyyy-MM-dd HH:mm:ss" width="150" headerAlign="center">审批时间
                    </div>
