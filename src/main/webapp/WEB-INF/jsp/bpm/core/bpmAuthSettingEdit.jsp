	...
	<div id="p1" class="form-container">
		<form id="form1" method="post">
				...
				<table class="table-detail column-two" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td><c:if test="${grantType=='bpmAssortment'}">流程分类</c:if>
						<c:if test="${grantType!='bpmAssortment'}">流程方案 </c:if>
						</td>
						<td  class="colums-padding">
							<div class="form-toolBox">
						         <a class="mini-button" id="addBtn"    onclick="selSolution()" plain="true" enabled="true">选择</a>
						         <a class="mini-button btn-red" id="delBtn"  onclick="removeSol()" plain="true" enabled="true">删除</a>
						         
							</div>
							<div class="colums-left">
							
							<div id="solGrid" class="mini-datagrid" style="width: 100%; min-height: 100px" allowResize="false" showPager="false"
							...
							<table>
								<tr>
									<td width="50%" style="padding-right: 3px">
										<div class="form-toolBox">
											...
											<a class="mini-button" id="addBtn"    onclick="setUser('def')" plain="true" enabled="true">选择</a>
											<a class="mini-button btn-red"     onclick="removeMember('def')" plain="true" enabled="true">删除</a>
										</div>
										<div  class="colums-left">
											<div id="defGrid" class="mini-datagrid" style="width: 100%; min-height:100px;" allowResize="false" showPager="false"
									...
									<td width="50%" style="padding-left: 3px">
										<div class="form-toolBox">
											<span>发起人员:</span>
											<a class="mini-button" id="addBtn"    onclick="setUser('start')" plain="true" enabled="true">选择</a>
											<a class="mini-button btn-red"   onclick="removeMember('start')" plain="true" enabled="true">删除</a>
										</div>
										<div class="colums-left">
											<div id="startGrid" class="mini-datagrid" style="width: 100%; min-height:100px;" allowResize="false" showPager="false"
											 allowAlternating="true">
												<div property="columns">
													<div field="name" width="140" headerAlign="center" >类型</div>
								...
								<tr>
									<td width="50%" style="padding-right: 3px">
										<div class="form-toolBox">
											<span>实例人员:</span>
											<a class="mini-button" id="addBtn"    onclick="setUser('inst')" plain="true" enabled="true">选择</a>
											<a class="mini-button btn-red"   onclick="removeMember('inst')" plain="true" enabled="true">删除</a>
										</div>
										<div class="colums-left">
											<div id="instGrid" class="mini-datagrid" style="width: 100%; min-height:100px;" allowResize="false" showPager="false"
												 allowAlternating="true">
												<div property="columns">
													<div field="name" width="140" headerAlign="center" >类型</div>
													<div field="names" width="100" headerAlign="center">配置</div>
									...
									<td width="50%" style="padding-left: 3px">
										<div class="form-toolBox">
											<span>任务人员:</span>
											<a class="mini-button" id="addBtn"    onclick="setUser('task')" plain="true" enabled="true">选择</a>
											<a class="mini-button btn-red"  onclick="removeMember('task')" plain="true" enabled="true">删除</a>
										</div>
										<div class="colums-left">
											<div id="taskGrid" class="mini-datagrid" style="width: 100%; min-height:100px;" allowResize="false" showPager="false"
											allowAlternating="true">
											<div property="columns">
												<div field="name" width="140" headerAlign="center">类型</div>
												<div field="names" width="100" headerAlign="center">配置</div>
