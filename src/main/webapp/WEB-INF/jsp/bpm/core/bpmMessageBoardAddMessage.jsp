	...
	<div class="messageBox">
		...
		<div id="p1" class="form-outer ">
			<form id="form1" method="post">
				...
				<div class="" >
					<textarea id="messageContent" name="messageContent" class="mini-textarea messageInput" emptyText="请输入留言内容" required="true" style="width: 100%"></textarea>
				</div>
				<div style="margin-top: 10px;text-align: right"><a class="mini-button" onclick="leaveMessage">留言</a></div>
			</form>
		</div>
	</div>
	<script>
