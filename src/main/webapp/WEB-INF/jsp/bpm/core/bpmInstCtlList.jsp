	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid"
			...
			<div property="columns">
				...
				<div name="action" cellCls="actionIcons" width="120"
					 renderer="onActionRenderer"
					cellStyle="padding:0;">操作</div>
				<div field="instId" width="120" 
					allowSort="true">${column.remarks}</div>
				<div field="type" width="120"  allowSort="true">${column.remarks}</div>
				<div field="right" width="120"  allowSort="true">${column.remarks}</div>
				<div field="allowAttend" width="120" 
					allowSort="true">${column.remarks}</div>
				<div field="allowStartor" width="120"  allowSort="true">${column.remarks}</div>
				<div field="groupIds" width="120" 
					allowSort="true">${column.remarks}</div>
				<div field="userIds" width="120" 
					allowSort="true">${column.remarks}</div>
			</div>
		</div>
	</div>
