...
<div class="mini-toolbar">
    <div style="text-align: center;"><a id="saveButton" class="mini-button"   onclick="CloseWindow('cancel')">确定</a>
    <a class="mini-button btn-red"   onclick="CloseWindow('cancel')">取消</a></div>
	</div>
