...
<script src="${ctxPath}/scripts/share/dialog.js?static_res_version=${static_res_version}" type="text/javascript"></script>
<style type="text/css">
	.table-detail > tbody > tr > th {width:20%;}
</style>
</head>
<body>
			...
			<form id="grantForm">
				<table class="table-detail column-two" style="width:100%;">
					...
					<tr class="rtable">
						...
						<td colspan="2" style="text-align: left">
							<span class="users">
								<a class="mini-button" onclick="selGroups('rgroupIds')">用户组</a>
							</span>
							...
							<span class="del_user">
								<a class="mini-button"  onclick="clearGroups('rgroupIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="rtable">
						...
						<td colspan="2">
							<span class="users">
								<a class="mini-button"  onclick="selUsers('ruserIds')">用&nbsp;&nbsp;&nbsp;户</a>
							</span>
							<span>
							...
							<span class="del_user">
								<a class="mini-button"  onclick="clearUsers('ruserIds')">清空</a>
							</span>
						</td>
					</tr>

					<tr class="atable">
						<td width="120" rowspan="2" style="font-size: 10px;">[附件打印]
						...
						<td style="text-align: left;">
							<span class="users">
								<a class="mini-button"  onclick="selGroups('printAgroupIds')">用户组</a>
							</span>
							<span>
							...
							<span class="del_user">
								<a class="mini-button"  onclick="clearGroups('printAgroupIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="atable">
						<td style="text-align: left">
							<span class="users">
								<a class="mini-button"  onclick="selUsers('printAuserIds')">用&nbsp;&nbsp;&nbsp;户</a>
							</span>
							<span>
							...
							<span class="del_user">
								<a class="mini-button"  onclick="clearUsers('printAuserIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="atable">
						<td width="120" rowspan="2" style="font-size: 10px;">[附件下载]
					...
					<tr class="atable">
						<td style="text-align: left">
							<span class="users">
								<a class="mini-button"  onclick="selUsers('downAuserIds')">用&nbsp;&nbsp;&nbsp;户</a>
							</span>
							<span>
