...
<body>
	...
	<div id="toolbar1" class="topToolBar" >
		<div>
	    	<a class="mini-button" plain="true" onclick="doCommute();">沟通</a>
		...
		<div class="mini-tabs" style="width: 100%; height: 100%;">
			...
			<div title="任务基本信息">
				...
				<table class="mini-toolbar mini-toolbar-bottom" style="width: 100%">
					<tr>
						<td><a class="mini-button" plain="true" onclick="saveTaskUsers()">保存任务人员</a></td>
					</tr>
				</table>
				<form id="userForm">
					<table style="width: 100%" class="table-detail column_2" cellpadding="0" cellspacing="1">
						...
						<tr>
							<td>候选用户</td>
							<td><input id="userLinks" name="userLinks" allowInput="false" class="mini-textboxlist" style="width: width:80%;" value="${canUserIds}" text="${canUserNames}" /> <a class="mini-button"   plain="true" onclick="addCanUsers()">添加</a></td>
							<td>候选用户组</td>
							<td><input id="groupLinks" name="groupLinks" allowInput="false" class="mini-textboxlist" style="width: width:80%;" value="${canGroupIds}" text="${canGroupNames}" /> <a class="mini-button"   plain="true" onclick="addCanGroups()">添加</a></td>
						</tr>
					</table>
				</form>
			</div>
