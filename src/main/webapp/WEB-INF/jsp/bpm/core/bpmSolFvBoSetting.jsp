...
<body>
		<div class="topToolBar">
			<div>
				<a class="mini-button"  plain="true" onclick="saveSetting">保存</a> 
		...
		<div class="mini-fit" >
			...
			<div id="tabs1" class="mini-tabs" onactivechanged="changeds" activeIndex="0" style="width: 100%;" plain="false">
				<div title="表单数据模型">
					<c:forEach items="${sysBoEntList}" var="sysBoEnt">
						<table class="table-detail column-four" cellspacing="1" cellpadding="0" tableName="${sysBoEnt.name}" boDefId="${sysBoEnt.boDefId}">
							<caption>${sysBoEnt.comment}-(${sysBoEnt.name})</caption>
							<tr>
								<td>字段名</td>
								<td>备注</td>
								<td style="width:150px">初始化设定</td>
								<td style="width:150px">保存设定</td>
							</tr>
