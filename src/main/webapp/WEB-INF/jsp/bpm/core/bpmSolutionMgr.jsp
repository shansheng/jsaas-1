...
<body>
	...
	<div class="mini-fit">
		<div id="layout1" class="mini-layout" style="width:100%;height:100%;box-sizing: border-box" >
		  <div 
		    	title="north" 
		    	region="north" 
		    	height="80" 
									...
									<div class="form-inner">
										<table style="width: 100%" class="table-detail column-four" cellpadding="0" cellspacing="1">
											...
											<tr>
												...
												<td>
													<c:choose>
														<c:when test="${bpmSolution.formal=='yes'}">是</c:when>
											...
											<tr>
												...
												<td>
													<c:choose>
														<c:when test="${bpmSolution.status=='CREATED'}">未发布</c:when>
