...
<html>
	...
	<body>
		<div class="form-toolBox">
			...
			<a class="mini-button" onclick="delAll('formGrid')">清空</a>
			<a class="mini-button"  plain="true" onclick="upRowGrid('formGrid')">向上</a>
			<a class="mini-button" plain="true" onclick="downRowGrid('formGrid')">向下</a>
		...
		<div class="mini-fit">
	        ...
	        editNextOnEnterKey="true"  editNextRowCell="true">
		        <div property="columns">
		            ...
		            <div type="checkboxcolumn" field="startUser" trueValue="true" falseValue="false" width="60" >含经办人</div>
