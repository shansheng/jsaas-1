...
<body>	
	<div class="mini-fit form-outer" style="height: 100%;">
		...
		idField="viewId" multiSelect="true" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" pageSize="20" allowAlternating="true" >
			<div property="columns">
				...
				<div name="action" cellCls="actionIcons" width="170"   renderer="onActionRenderer" cellStyle="padding:0;">操作</div>
				<div field="name" width="120"  allowSort="true">名称</div>
				<div field="key" width="120"  allowSort="true">标识键</div>
				<div field="type" width="100"  allowSort="true" renderer="onTypeRenderer">类型</div>
				<div field="isMain" width="50"  allowSort="true" renderer="onIsMainRenderer">主版本</div>
				<div field="version" width="100"  allowSort="true">版本号</div>
				<div field="status" width="100"  allowSort="true" renderer="onStatusRenderer">状态</div>
			</div>
		</div>
	</div>
    ...
    function onActionRenderer(e) {
        ...
        var s =  ' <span  title="编辑" onclick="editRow(\'' + uid + '\',true)">编辑</span>'
                + ' <span  title="设置为主版本" onclick="setMainRow(\'' + uid + '\')">设置为主版本</span>';
