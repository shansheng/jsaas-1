...
<body>
	<div class="topToolBar" >
		<div>
			...
			<a class="mini-button" plain="true" onclick="saveFormAndBo">确定</a>
		</div>
	</div>
...
<div class="mini-fit">
	<div class="form-container" >
		<form id="form1" method="post">
			<div>
				<table class="table-detail column-four" cellspacing="1" cellpadding="0" border="0">
					<tr>
						<td>分　　类 </td>
						<td>
