...
<body>
	...
	<div class="buttom-toolbar" style="text-align: center;">
		<a class="mini-button" plain="false" onclick="onOk">保存</a>
		<a class="mini-button btn-red" plain="false" onclick="CloseWindow();">取消</a>
	</div>
