...
<body>
	...
	<redxun:toolbar entityName="com.redxun.oa.pro.entity.PlanTask" excludeButtons="popupAddMenu,popupAttachMenu,detail,edit,remove,popupSearchMenu,fieldSearch,popupSettingMenu,export,importData" >
