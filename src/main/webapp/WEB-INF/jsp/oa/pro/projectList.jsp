...
<body>
	<ul id="treeMenu" class="mini-contextmenu" >
		<li  onclick="addNodeList()">新增子分类</li>
	...
	<div id="layout1" class="mini-layout" style="width:100%;height:100%;" >
    	...
    	>
	        <div class="treeToolBar">
				<a class="mini-button"  plain="true" onclick="addNodeInFirst()">新增根分类</a>
	    ...
	    <div showHeader="false" showCollapseButton="false"  region="center">
			...
			>
				<div class="self-toolbar mini-toolbar-top">
					<li>
						<a class="mini-button"  onclick="addOne()" plain="true">新增项目</a>
					</li>
				</div>
			</redxun:toolbar>
