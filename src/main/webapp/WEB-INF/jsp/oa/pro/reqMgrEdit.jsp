...
<body>
	...
	<a class="mini-button"  plain="true" onclick="onOk">保存草稿</a>
	        <a class="mini-button"  plain="true" onclick="submitAndSave">提交保存</a>
	   </div>
	</rx:toolbar>
		</div>
		</div>
		...
		<form id="form1" method="post">
			<div class="form-inner">
				...
				<table class="table-detail column_2_m" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td>标　　题 <span class="star">*</span> </td>
						<td colspan="3"><input name="subject" value="${reqMgr.subject}" class="mini-textbox" vtype="maxLengtd:128" style="width: 100%"
							required="true" emptyText="请输入标题" /></td>
					</tr>
						
						<td>需求编码 <span class="star">*</span> 
						</td>
						...
						<td>选择版本  <span class="star">*</span></td>
					...
					<tr style="display: none;">
						...
						<td>项目或产品Id <span class="star">*</span> 
						</td>
