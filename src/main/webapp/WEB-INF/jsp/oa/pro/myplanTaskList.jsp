...
<body>
	...
	<redxun:toolbar 
		...
		excludeButtons="popupAddMenu,popupAttachMenu,detail,edit,remove,popupSearchMenu,popupSettingMenu,export,importData"  
	>
	<div class="self-toolbar">
		<li>
			<a class="mini-button" onclick="addOne()" plain="true">新增计划</a>
		</li>
	</div>
	</redxun:toolbar>
	...
	<div class="mini-fit rx-grid-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"  url="${ctxPath}/oa/pro/planTask/myList.do" onrowdblclick="openDetail(e)"
			...
			<div property="columns">
				...
				<div field="subject" width="120"   allowSort="true">计划标题</div>
				<div field="content" width="120"   allowSort="true">计划内容</div>
				<div field="pstartTime" width="121"   renderer="onRenderer" allowSort="true">计划开始时间</div>
				<div field="pendTime" width="121"   renderer="onRenderer" allowSort="true">计划结束时间</div>
				<div field="startTime" width="121"   renderer="onRenderer" allowSort="true">实际开始时间</div>
				<div field="endTime" width="121"  renderer="onRenderer" allowSort="true">实际结束时间</div>
				<div field="status" width="120" >状态</div>
			</div>
		</div>
	</div>
