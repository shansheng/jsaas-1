...
<body>
	...
	<a id="saving" class="mini-button" plain="true" onclick="selfSaveData('DRAFT')">保存草稿</a>
    <a id="pending" class="mini-button" plain="true" onclick="selfSaveData('PENDING')">提交保存</a>
					...
					<tr id="trplanId" >
						...
						<td colspan="3">
							<input 
						        ...
						        showTreeIcon="false" 
					        />
					        <a  class="mini-button" plain="true" onclick="setValueNull">置空</a>
						</td>
					</tr>
