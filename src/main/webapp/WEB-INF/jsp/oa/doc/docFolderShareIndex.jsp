...
<body oncontextmenu="return false">
 ...
 <a class="mini-menubutton" plain="true" menu="#popupFileMenu">新增文件</a>
		<span class="separator"></span>
		<a class="mini-button"  onclick="addFolder" plain="true">新增文件夹</a>
		<span class="separator"></span>
		<a class="mini-button" plain="true" onclick="location.reload(true)">页面刷新</a>
	    <span class="separator"></span>
	 <input class="text" id="key" name="key" />     <a class="mini-button"  plain="true" onclick="searchByKey" tooltip="包含该字段的条目">查找</a>
    ...
    allowResize="true" expandOnLoad="true" allowCellSelect="true">
			<div property="columns">
				<div name="action" cellCls="actionIcons" width="40"
  ...
  //设置文件夹图标
    ...
    function onActionRenderer(e) {
        ...
        var s = '<span title="明细" onclick="detailRow2(\'' + pkId + '\')">明细</span>';
        return s;
    }
