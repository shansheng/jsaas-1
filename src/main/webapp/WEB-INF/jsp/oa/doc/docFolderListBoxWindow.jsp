...
<ul id="popupFileMenu" class="mini-menu" style="display:none;">
	    <li onclick="addDoc('html')">Html文档</li>
	    <li  onclick="addDoc('doc')">Word文档</li>
	 ...
	 <div class="topToolBar" style="padding:2px;">
	 	<div>
		<a class="mini-button" plain="false" onclick="location.reload(true)">页面刷新</a>
	    <a class="mini-button"  plain="false" onclick="toBefore()">后退</a>
	    <a id="adddoc" class="mini-menubutton" plain="false" menu="#popupFileMenu">新增文件</a>
	    <a id="addfolder" class="mini-button" plain="false" onclick="addFolder()">添加文件夹</a>
	    <a id="toparentFolder" class="mini-button"  plain="false" onclick="toparentFolder()">返回上级目录</a>
	    <input class="text" id="key" name="key"  style="height:26px;vertical-align:middle;"/>    
	    <a id="toparentFolder" class="mini-button"  plain="false" onclick="finddaf()">查找</a>
	    <a id="toparentFolder" class="mini-button"  plain="false" onclick="clearsearch()">清空</a>
	    </div>
     </div>



<div class="mini-fit" style="height: 100%;background:#fff;" >
	 ...
	 <ul id="listMenu" class="mini-contextmenu" >
		...
		<li class="separator"></li>
		<li name="delete" iconCls="icon-remove" class=" btn-red" onclick="deleteFolderAndFile()">删除</li>
	</ul> 
	</div>
	...
	<li name="delete" iconCls="icon-remove" class=" btn-red" onclick="deletedoc()">删除</li>
	</ul>
	</div>
