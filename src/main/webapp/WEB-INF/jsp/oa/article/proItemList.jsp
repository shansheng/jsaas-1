     ...
     <div class="titleBar mini-toolbar" >
		...
		<div class="searchBox">
			<form id="searchForm" class="search-form" >						
				<ul>
					<li>
						<span class="text">项目名：</span><input class="mini-textbox" name="Q_NAME__S_LK">
					</li>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			...
			<div property="columns">
				...
				<div field="alias"  sortField="VERSION_"  width="120" headerAlign="center" allowSort="true">项目别名</div>
				<!-- <div field="createBy"  sortField="GEN_SRC_"  width="120" headerAlign="center" allowSort="true">创建人</div> -->
