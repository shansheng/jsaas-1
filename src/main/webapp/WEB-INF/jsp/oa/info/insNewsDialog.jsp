...
<body>
	...
	<div class="mini-toolbar" style="border-bottom: 0; padding: 0px;">
		<table style="width: 100%;">
			<tr>
				<td style="width: 100%;"><a class="mini-button" iconCls="icon-select" plain="true" onclick="CloseWindow('ok');">选择</a> <a class="mini-button btn-red" plain="true" onclick="CloseWindow('cancel');">关闭</a></td>
			</tr>
			<tr>
				<td style="white-space: nowrap; border-top: 1px solid #909aa6; padding: 5px;">
					<form id="searchForm" class="search-form" >
						...
						<a class="mini-button btn-red" iconCls="icon-cancel" onclick="onClear">清空</a>
					</form>
				</td>
			</tr>
		</table>
