...
<body>
		 ...
		 <div class="searchBox">
			 <form id="searchForm" class="search-form" >
				 <ul>
					...
					<li>
						<span class="text-to">到：</span><input name="Q_endTime_D_LT" class="mini-datepicker" value="" format="yyyy-MM-dd" />
	 ...
	 <div class="mini-fit" style="height: 100%;">
		 ...
		 >
			<div property="columns">
				...
				<div name="status" field="status" cellCls="actionIcons"
					 width="22" allowSort="false" headerAlign="center" align="center"
					 cellStyle="padding:0;">状态</div>
				<div name="action" cellCls="actionIcons"
					 width="50" allowSort="false" headerAlign="center" align="center"
					 renderer="onActionRenderer" cellStyle="padding:0;">操作</div>
				<div field="content" headerAlign="center" width="200" allowSort="false" allowSort="true">消息内容</div>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = '<span title="查看" onclick="readMsg(\'' + pkId + '\')">查看</span>';
			return s;
		}
		...
		function onDrawCell(e) {
			...
			if (e.field == "status") {
				if (isRead == "yes") {
					e.cellHtml = '<span title="已读">已读</span>';
				} else if (isRead == "no") {
					e.cellHtml = '<span  title="未读">未读</span>';
				} else if (isRead == "group") {
					e.cellHtml = '<span  title="组消息">组消息</span>';
				}
			}
		}
