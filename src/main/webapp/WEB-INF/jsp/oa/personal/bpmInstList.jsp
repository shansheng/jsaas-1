				...
				<div class="mini-toolbar">
					<div class="searchBox">
						<form id="searchForm" class="search-form" >
							<ul>
								<li><span class="text">发起人:</span><input class="mini-buttonedit" allowInput="false" name="userId" onbuttonclick="selectUser"/></li>
								<li><span class="text">事项:</span><input class="mini-textbox" name="subject" onenter="onSearch" /></li>
								...
								<ul>
									<li>
										...
										<input class="mini-combobox"
											   name="status" data="[{id:'DRAFTED',text:'草稿'},{id:'RUNNING',text:'运行中'},{id:'SUCCESS_END',text:'成功结束'}]"/>
									</li>
									<li>
										<span class="text">创建时间从:</span>
										<input class="mini-datepicker" name="Q_createtime1_D_GE" onenter="onSearch"/>
									</li>
									<li style="width: auto;">
										<input class="mini-datepicker" name="Q_createtime2_D_LE" onenter="onSearch" />
									</li>
								</ul>
							</div>
						</form>
