...
<body>
	<div  class="topToolBar" >
		<div>
			 <a class="mini-button" plain="true" enabled="true" onclick="grantToUser()">授权用户</a>
		     <a class="mini-button" plain="true" enabled="true" onclick="grantToGroup()">授权用户组</a>
		     <a class="mini-button btn-red" plain="true" enabled="true" onclick="remove()">删除</a>
		</div>
	</div>
