		...
		<div class="form-container">
			<form id="form1">
				<table>
					<tr>
						<td>计算方式</td>
						<td><input id="computeWay" name="computeWay" class="mini-combobox" allowInput="false" style="width:160px;margin-bottom: 5px" textField="text" valueField="id"  onvaluechanged="changeComputeWay()"
						data="[{ 'id':'time','text':'时长'},{ 'id':'date','text':'时间点'}]" value="time"  required="true" allowInput="true" showNullItem="true" nullItemText="请选择..."/></td>
					<tr>
						<td>选择开始日期</td>
						<td>
						 <input id="startDate" name="startDate" class="mini-datepicker" style="width:160px;margin-bottom: 5px" onvaluechanged="validateStart()" nullValue="null"
