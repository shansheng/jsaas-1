...
<ul id="contextMenu" class="mini-contextmenu" >
	<li onclick="removeCalendar()">删除</li>
</ul>

<div class="fitTop"></div>
<div class="mini-fit">
	<div class="mini-layout" style="width: 100%;height: 100%;">
		<div region="east" showHeader="false" width="300">
			<div class="form-toolBox" style="font-size: 14px">
				<form id="form1" method="post">
					<div class="padDiv">
						<a class="mini-button" onclick="clearTheUpdate();">班次定义</a>
					</div>
					<div class="padDiv">
						<input
								id="workTimeBlock"
					...
					<div class="padDiv">
						<span>时间段命名：</span>
						<input id="grantNameToTimeBlock" name="settingName" class="mini-textbox"   required="true" style="width: 100%" />
					</div>

					<div class="padDiv">
						<p>选择时间段：</p>
						<span>从：</span>
						<input id="startTime" name="startTime"  class='mini-timespinner' allowInput='true' format='HH:mm'  required="true" style="width: 100%" />
						<span>至：</span>
						<input id="endTime" name="endTime"  class='mini-timespinner' format='HH:mm' allowInput='true' required="true" style="width: 100%"  onvaluechanged="floatMsg()"/>
					</div>
					<div class="padDiv">
						<a class="mini-button"  onclick="saveTheDiyBlock()">保存</a>
						<%--<a class="mini-button" onclick="addAnotherTimeBlock()" >添加</a>--%>
						<a class="mini-button btn-red"   onclick="removeAnotherTimeBlock()" >清空</a>
					</div>
				</form>
			</div>
...
<script type="text/javascript">
	...
	function onDrawCells(e) {
		...
		e.cellHtml = '<span title='+ancientValue+'>'+value+'</span>'
				+'<span style="color:red;font-size:15px;float:right;width:15px;cursor:pointer;" title="删除" onclick="deleteBlock(\''+item.settingId+'\');event.cancelBubble=true;"> ×</span>';
