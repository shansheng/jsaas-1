...
<!-- <div id="toolbar1" class="mini-toolbar" style="padding:2px;">
    <table style="width:100%;">
        <tr>
	        <th style="width:100%;">
	            <a class="mini-button" iconCls="icon-addfolder" plain="true" enabled="true" onclick="newSetting()">新增</a>
	        </th>
        </tr>
    </table>
</div> -->
...
<div class="mini-toolbar">
         <ul class="toolBtnBox">
			<li style="margin-top: 15px;margin-left: 15px">
				<a class="mini-button" plain="true" enabled="true" onclick="newSetting()">新增</a>
			</li>
		</ul>
     </div>
	...
	<div class="mini-fit rx-grid-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			...
			<div property="columns">
				<div name="action" cellCls="actionIcons" width="90" renderer="onActionRenderer"
					cellStyle="padding:0;">操作</div>
				<div field="calName" width="120"  allowSort="true">日历名称</div>
				<div field="isCommon" width="120"  allowSort="true" renderer="onIsCommonRenderer">是否默认</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
	        ...
	        function onActionRenderer(e) {
	            ...
	            var s = '<span title="日历设定" onclick="openCalendar(\'' + pkId + '\')">日历设定</span>'
	                    + ' <span title="编辑" onclick="editRow(\'' + pkId + '\')">编辑</span>'
	                    + '<span title="分配" onclick="grant(\'' + pkId + '\')">分配</span>'
	                    +' <span title="测试" onclick="debugRow(\'' + pkId + '\')">测试</span>'
	                    +' <span title="设置为默认" onclick="defaultCenter(\'' + pkId + '\')">设置为默认</span>'
