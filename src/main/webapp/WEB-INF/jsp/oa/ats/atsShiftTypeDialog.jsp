...
<body>
		 ...
		 <div title="业务视图列表" region="center" showHeader="false" showCollapseButton="false">
		 	...
		 	<div id="grid1" class="mini-datagrid"
				...
				<div property="columns">
					<div type="indexcolumn"headerAlign="center" align="center" width="8%">序号</div>
	...
	<script type="text/javascript">
		...
		grid.setUrl("${ctxPath}/oa/ats/atsShiftType/listData.do?Q_STATUS_S_LK=1");
