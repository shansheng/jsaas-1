...
<html>
<head>
<title>假期类型列表管理</title>
<%@include file="/commons/list.jsp"%>
</head>
<body>

	<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		 <div region="south" showSplit="false" showHeader="false" height="45" showSplitIcon="false"  style="width:100%" bodyStyle="border:0;padding-top:5px;">
	...
	<script type="text/javascript">
		...
		grid.setUrl("${ctxPath}/oa/ats/atsHolidayType/listData.do?Q_STATUS_S_LK=1");
