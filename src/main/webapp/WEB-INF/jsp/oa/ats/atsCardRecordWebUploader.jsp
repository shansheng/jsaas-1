...
<body >
	<div class="mini-toolbar" >
		<ul class="toolBtnBox">
			<li><a class="mini-button"   plain="true" onclick="onOk()">导入</a></li>
			<li><a class="mini-button"   plain="true" onclick="report()">导出打卡数据模板</a></li>
			<li><a class="mini-button btn-red"   plain="true" onclick="onCancel()">关闭</a></li>
		</ul>
	</div>
	<div class="mini-toolbar" >
...
function report(){
	location.href=__rootPath+"/oa/ats/atsCardRecord/exportData.do?isTemp=true";
}
...
$(function(){
    ...
    var config={
        ...
        // 文件接收服务端。
        server: __rootPath+'/oa/ats/atsCardRecord/importData.do',
        // 选择文件的按钮。可选。
    ...
    uploader.on("error",function (type){
    	if(type == "F_DUPLICATE"){
    	   ...
    	   mini.alert("上传文件类型出错!目前允许的上传类型为:<br/>xlsx,xls");
       }
    });
