	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a class="mini-button"   plain="true" onclick="report()">导出考勤档案数据模板</a>
...
function report(){
	location.href=__rootPath+"/oa/ats/atsAttendanceFile/exportData.do";
}
...
$(function(){
    ...
    var config={
        ...
        // 文件接收服务端。
        server: __rootPath+'/oa/ats/atsAttendanceFile/importData.do',
        // 选择文件的按钮。可选。
