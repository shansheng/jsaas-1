...
<body>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			url="${ctxPath}/oa/ats/atsShiftType/listData.do" idField="id"
	...
	<redxun:gridScript gridId="datagrid1" entityName="com.redxun.oa.ats.entity.AtsShiftType" winHeight="450"
		winWidth="700" entityTitle="班次类型" baseUrl="oa/ats/atsShiftType" />
</body>
</html>