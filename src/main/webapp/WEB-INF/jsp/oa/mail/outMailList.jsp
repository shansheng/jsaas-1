...
<body>
		...
		<table style="width: 100%;" class="mini-toolbar-background">
			<tr>
				<td style="width: 30%;">
					...
					<a id="toDel" class="mini-button btn-red"  onclick="todelfolder">刪除</a> 
					<a class="mini-button"  onclick="Del">彻底删除</a> 
					<a class="mini-button"   onclick="transmit">转发</a> 
					<span class="separater"></span>
					<a class="mini-button"   onclick="onMoveNode">移动到</a>
				...
				<td>
					<form id="searchForm" class="search-form" >
						<div>
							...
							<span class="text"> 时间：</span><input id="sDate" name="Q_sendDate_D_GE" class="mini-datepicker" value="" format="yyyy-MM-dd" /><span class="text"> 至：</span><input id="eDate" name="Q_sendDate_D_LE" class="mini-datepicker" value="" format="yyyy-MM-dd" />
						</div>
					</form>
				</td>
			</tr>
			...
			<table style="width: 100%">
				<tr>
					<td>						
						...
						<a class="mini-button btn-red" onclick="hideWindow()">取消</a>
					</td>
				</tr>
			</table>
		</div>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = '<span title="查看" onclick="getRow1(\'' + pkId + '\')">查看</span>' + ' <span title="删除" onclick="rowToDel(\'' + pkId + '\')">删除</span>';
			return s;
		}
