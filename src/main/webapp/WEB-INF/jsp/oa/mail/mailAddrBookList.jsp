		...
		<div title="center" region="center" width="100%" showSplitIcon="true">
			<div id="toolbar1" class="mini-toolbar" style="padding: 2px;">
				<form id="searchForm" class="search-form" >
					姓名： <input id="name" name="name" class="mini-textbox" />
					邮箱： <input id="mail" name="mail" class="mini-textbox" />
					<a class="mini-button" onclick="onSearch" plain="true">查询</a>
					<a class="mini-button" onclick="closeWindow" plain="true">添加</a>
				</form>
			</div>
