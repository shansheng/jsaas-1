...
<body>
	<div class=" mini-toolbar" >
			...
			<form id="searchForm" class="search-form" >						
				<ul>
					...
					<li class="liBtn">
						...
						<a class="mini-button _reset btn-red" onclick="onClearList(this)" >清空</a>
					</li>
				</ul>
				<div id="moreBox">
					<ul>
		...
		<ul class="toolBtnBox">
			<li>
				<a class="mini-button" onclick="writeMail">写邮件</a>
			</li>
			<li>
				<a class="mini-button" onclick="transmit">转发</a>
			</li>
			<li>
				<a class="mini-button" onclick="moveMailToTargetFolder">移动到</a>
			</li>
			<li>
				<a class="mini-button"  onclick="refresh">刷新</a>
			</li>
			<li>
				<a id="toDel" class="mini-button btn-red" onclick="toDel">刪除</a>
			</li>
			<li>
				<a class="mini-button btn-red" onclick="del">彻底删除</a>
			</li>
		</ul>
	...
	<div class="mini-fit rx-grid-fit form-outer5" style="height: 100%;">
		...
		>
			<div property="columns">
				...
				<div name="action" cellCls="actionIcons" width="60"  renderer="onActionRenderer" cellStyle="padding:0;">操作</div>
				<div field="urge" width="20"  allowSort="true" align="center" headerAlign="center">紧急状态</div>
				<div field="isRead" name="isRead" width="40"  align="center" headerAlign="center">阅读状态</div>
				<div field="isReply" name="isReply" width="40"  align="center" headerAlign="center">回复状态</div>
				<div field="subject" width="150"  allowSort="true">邮件标题</div>
				<div field="sender" name="sender" width="80"  allowSort="true" visible="false">发送人</div>
				<div field="recNames" name="recNames" width="60"  allowSort="true" visible="false">收信人</div>
				<div field="senderTime" width="60"  allowSort="true" dateFormat="yyyy-MM-dd HH:mm">发送时间</div>
        ...
        var grid=mini.get("datagrid1");
	        ...
	        function onActionRenderer(e) {
	           ...
	           // var pkId = record.pkId; 
	            var uId=record._uid;
	            var s = '<span title="明细" onclick="check('+uId+')">明细</span>'
	                    + ' <span title="删除" onclick="toDel()">删除</span>';
	            return s;
	        }
        	...
        	$(function(){
        		...
        		if(isShowDel=="NO")   //不显示彻底删除按钮
         		...
         		var type = "${param['type']}";
         		if(type=="SENDER-FOLDER"){
         			grid.showColumn("recNames");
         		}else if(type=="DRAFT-FOLDER"){
         			grid.hideColumn("isRead");
         			grid.hideColumn("isReply");
         		}else{
         			grid.showColumn("sender");
         		}
		    ...
		    grid.on("drawcell", function (e) {
					...
					if(field=='isReply'){  //设置回复标识图标
						if(value=="NO"){
							s="<i title='未回复' class='iconfont   icon-youxiang01' ></i>";
						}
						else{
							s="<i title='已回复' class='iconfont  icon-mailUp' ></i>";
						}
						e.cellHtml= s;
					}
