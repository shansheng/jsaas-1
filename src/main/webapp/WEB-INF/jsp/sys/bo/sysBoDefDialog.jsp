...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
    ...
    <div title="业务视图分类" region="west" width="170" showSplitIcon="true">
        <ul id="systree" class="mini-tree" url="${ctxPath}/sys/core/sysTree/listByCatKey.do?catKey=CAT_FORM_VIEW"
            style="width:100%;height:100%;"
            showTreeIcon="true" textField="name" idField="treeId" resultAsTree="false" parentField="parentId"
            expandOnLoad="true"
    ...
    <div title="业务视图列表" region="center" showHeader="false" showCollapseButton="false">
        <div class="mini-toolbar">
            <ul class="toolBtnBox toolBtnBoxTop">
                <li>
                    <span class="text">名称：</span><input class="mini-textbox" name="Q_NAME__S_LK" style="width: 180px">
                </li>
                <li> <span class="text">别名：</span><input class="mini-textbox" name="Q_ALAIS__S_LK" style="width: 180px"></li>
                <li>
                    <a class="mini-button"   plain="true"
                       onclick="searchForm(this)" >查询</a>
                </li>
                <li  style="margin-right: 0">
                    <a class="mini-button btn-red"   plain="true"
                       onclick="onClearList(this)"  style="margin-right: 0">清空</a>
                </li>
            </ul>
        </div>
        <div class="mini-fit rx-grid-fit">
            <div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
                 url="${ctxPath}/sys/bo/sysBoDef/listData.do?Q_SUPPORT_DB__S_EQ=${param.Q_SUPPORT_DB__S_EQ}"
                 idField="id"
                 multiSelect="${param.multi}" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" pageSize="20"
                ...
                <div property="columns">
                    ...
                    <div field="supportDb" sortField="SUPPORT_DB_" renderer="onDbRenderer" width="120"
                         headerAlign="center" allowSort="true">支持数据表
                    </div>
                    <div field="createTime" sortField="CREATE_TIME_" dateFormat="yyyy-MM-dd HH:mm:ss" width="120"
                         headerAlign="center" allowSort="true">创建时间
                    </div>
                </div>
            </div>
        </div>
