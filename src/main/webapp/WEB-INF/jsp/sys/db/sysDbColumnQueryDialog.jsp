...
<body>
	...
	<div class="mini-toolbar"
		...
		<a    class="mini-button"  onclick="onOk()">确定</a> <span
			style="display: inline-block; width: 25px;"></span> <a
			  class="mini-button" onclick="onCancel()">取消</a>
	</div>
	<script type="text/javascript">
		...
		function loadData(queryType,query,ds){
			...
			grid.load({queryType:queryType,query:query,ds: ds}, function(result){
				if(result.data.length<1){
					alert("请检查SQL语句书写是否正确！");
					onCancel();
				}
			});
		}
