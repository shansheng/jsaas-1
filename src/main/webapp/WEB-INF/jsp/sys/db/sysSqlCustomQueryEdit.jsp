...
<script src="${ctxPath}/scripts/sys/customform/sysCustom.js"></script>
<style type="text/css">
.mini-tabs-bodys {
...
<body>
	<div id="div_toolbar1" class="topToolBar" >
		<div>
		   	 <a class="mini-button" plain="true" onclick="selfSaveData">保存</a>
		</div>  
	</div>
	...
	<div class="form-container">
		...
		<div id="tabs1" class="mini-tabs" activeIndex="0" plain="false"
			...
			<div title="基本信息">
				<form id="form1" method="post">
					<input id="pkId" 
						name="id" 
						class="mini-hidden"
						value="${sysSqlCustomQuery.id}" /> 
					<input id="table" 
						name="table"
						class="mini-hidden" 
						value="${sysSqlCustomQuery.table}" />
				...
				<div class="shadowBox">
					<table class="table-detail column-two" cellspacing="1"
						...
						<tr>
							...
							<td>分类选择 *</td>
							<td>
								<input id="treeId" name="treeId" class="mini-treeselect" url="${ctxPath}/sys/core/sysTree/listByCatKey.do?catKey=CAT_CUSTOM_SQL"
									   multiSelect="false" textField="name" valueField="treeId" parentField="parentId"  required="true" value="${sysSqlCustomQuery.treeId}"
			...
			<div title="返回字段" showCloseButton="false">
				<div class="form-toolBox">
					<a class="mini-button"  plain="true"
						onclick="selectColumnQuery">列头设置</a> <a class="mini-button btn-red"
						 plain="true"
						onclick="removeRow('gridQuery')">删除</a> <span class="separator"></span>
					<a class="mini-button" plain="true"
						onclick="upRowGrid('gridQuery')">向上</a> <a class="mini-button"
						 plain="true" onclick="downRowGrid('gridQuery')">向下</a>
				</div>
				<div id="gridQuery" class="mini-datagrid" style="width: 100%;"
					...
					<div property="columns">
						...
						<div field="reg" width="120" headerAlign="center">
							替换规则 <input property="editor" id="buttonEditEditor" class="mini-buttonedit" allowInput="false" onbuttonclick="onRegShow"/>
						</div>
					</div>
				</div>
			</div>
			<div title="条件的列" showCloseButton="false">
				<div class="form-toolBox">
					<a class="mini-button" plain="true"
						onclick="selectColumnWhere">列头设置</a> <a class="mini-button btn-red" plain="true"
						onclick="removeRow('gridWhere')">删除</a> <span class="separator"></span>
					<a class="mini-button" plain="true"
						onclick="upRowGrid('gridWhere')">向上</a> <a class="mini-button" plain="true" onclick="downRowGrid('gridWhere')">向下</a>
				</div>
			...
			<div title="排序" showCloseButton="false">
				<div class="form-toolBox">
					<a class="mini-button" plain="true"
						onclick="selectColumnOrder">列头设置</a> <a class="mini-button btn-red"
						 plain="true"
						onclick="removeRow('gridOrder')">删除</a> <span class="separator"></span>
					<a class="mini-button" plain="true"
						onclick="upRowGrid('gridOrder')">向上</a> <a class="mini-button"
						 plain="true" onclick="downRowGrid('gridOrder')">向下</a>
				</div>
