							...
							<tr>
								...
								<td colspan="3">
									<input id="userId" name="userId"
										   ...
										   allowInput="false" style="width: 90%;height: 30px"  value="${osDimensionRight.userId}" />
									<a class="mini-button"  onclick="selUser()">选择</a>
								</td>
							</tr>
							<tr>
								<td >用户组</td>
								<td colspan="3"><input id="groupId"
													   name="groupId"
													   class="mini-textboxlist"
													   allowInput="false" style="width: 90%;height: 30px"  value="${osDimensionRight.groupId}" />
