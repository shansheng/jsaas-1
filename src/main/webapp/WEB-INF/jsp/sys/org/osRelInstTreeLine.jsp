...
<body>
	<ul id="nodeMenu" class="mini-contextmenu" onbeforeopen="onShowingNodeMenu">        
	    <li   onclick="addRelInst">增加关系</li>
	    <li name="editItem1"  onclick="editInst">更换关系</li>
	    <li name="editItem2"  onclick="editInstRow">编辑人员信息</li>
	    <li name="delItem"   onclick="delInst">删除关系</li>
	</ul>

	<div id="toolbar1" class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;">
		<div class="form-toolBox">
			 <a class="mini-button"  plain="true" onclick="refreshTree()">刷新关系</a>
			 <a class="mini-button"  plain="true" onclick="showRelInstImage()">关系实例图</a>
		</div>
	...
	<script type="text/javascript">
		...
		function onShowingNodeMenu(e){
			...
			var editItem1=mini.getByName('editItem1',menu);
			var editItem2=mini.getByName('editItem2',menu);
