...
<body>
	...
	<script type="text/javascript">
		...
		$.getJSON(
			    "${ctxPath}/sys/org/osGradeAdmin/getGrantedResourceIds.do?groupId=${param['groupId']}",
			    function(result) {
			       tree.setUrl('${ctxPath}/sys/org/osGradeAdmin/getMenusByInstType.do?tenantId=${param['tenantId']}');
