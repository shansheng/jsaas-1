...
<body>
	<div class="topToolBar">
		<div >
			<span style="vertical-align: middle">关系定义：【 ${osRelType.name}】-</span>
			<label class="selected-node-group" style="vertical-align: middle;font-size: 14px;">选择关系方：</label>
			<input type="text" id="selected-node" class="selected-node-group" readonly="readonly"
				   style="height: 28px;width: 160px;vertical-align: middle;border: 0 ;border-radius: 2px;border: 1px solid #ddd;"
			>
			<span id="node-type-panel" class="radio-panel" style="font-size: 14px;">

	    	</span>
			<a id="btn-add-nodes" class="mini-button">添加下级</a>
			<a id="btn-delete-nodes" class="mini-button">删除</a>
			<a  class="mini-button" onclick="location.reload();">刷新</a>
		</div>
	</div>

	<div class="mini-fit" style="background: #fff;">
 	  <div id="chart-container" style="width: 100%;padding: 10px;height: 100%;">
