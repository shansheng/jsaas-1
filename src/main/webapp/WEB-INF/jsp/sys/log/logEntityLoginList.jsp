             ...
             <tr>
              ...
              <tr>
                  <td  class="search-form" >
                     <ul>
						<li><span class="text">操作人:</span><input class="mini-combobox" style="width:150px;" textField="fullname"  valueField="userId"  url="${ctxPath}/sys/org/osUser/listTenantUser.do" showNullItem="true" allowInput="true" name="Q_CREATE_BY__S_LK"></li>
						<li>
							<span class="text">登录时间</span><input  name="Q_CREATE_TIME__D_GE"  class="mini-datepicker" format="yyyy-MM-dd" style="width:100px"/>
						</li>
						<li>
							<span class="text">~</span><input  name="Q_CREATE_TIME__D_LE" class="mini-datepicker" format="yyyy-MM-dd" style="width:100px" />
						</li>
						<li>
							<span class="text">登出时间 </span><input  name="Q_UPDATE_TIME__D_GE"  class="mini-datepicker" format="yyyy-MM-dd" style="width:100px"/>
						</li>
						<li>
							<span class="text">~</span><input  name="Q_UPDATE_TIME__D_LE" class="mini-datepicker" format="yyyy-MM-dd" style="width:100px" />
						</li>
						<li><span class="text">登录IP</span><input class="mini-textbox" name="Q_IP__S_LK"></li>
						<li><span class="text">主部门</span><input class="mini-textbox" name="Q_MAIN_GROUP_NAME__S_LK"></li>
					</ul>
                  </td>
              </tr>
         </table>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
			...
			<div property="columns">
				...
				<!-- <div name="action" cellCls="actionIcons" width="50" headerAlign="center" align="center" renderer="onActionRenderer" cellStyle="padding:0;">相关#</div> -->
