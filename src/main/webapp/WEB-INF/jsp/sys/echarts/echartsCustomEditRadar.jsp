...
<body>
	...
	<div class="form-container">
		<form id="form1" method="post">
			...
			<input id="table" name="echartsType" class="mini-hidden" value="Radar" />
				...
				<div title="数据字段" showCloseButton="false">
					<div class="form-toolBox" >
						...
						<table class="table-detail column-four" cellspacing="1" cellpadding="0" style="margin-top: 0;">
							<tr>
								<td>数据调用方式</td>
								<td><input id="detailMethod-radar" name="detailMethod" class="mini-radiobuttonlist" valueField="id" textField="text" 
									data="[{'id':1, 'text':'行数据雷达'}, {'id':0, 'text':'列数据雷达'}]" 
								...
								<td><input id="series-selectedMode" class="mini-radiobuttonlist" valueField="id" textField="text" 
									data="[{'id':0, 'text':'关'}, {'id':1, 'text':'开'}]" value="0"/></td>
							</tr>
							<tr>
								<td>半径</td>
								<td><input id="series-maxRadius" class="mini-textbox" vtype="range:0,100" 
									style="width:60px;font-size:10px;" value="60" maxlength="4"/>%</td>
								<td>中心位置</td>
								<td>
	...
	<script type="text/javascript">
		...
		function selfSaveData() {
			...
			series.radius = [0, mini.get("series-maxRadius").getValue()];
