	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;" id="toolbarBody">
	               	 <a class="mini-button"  plain="true" onclick="close">确定</a>	               
	                 <a class="mini-button" plain="true" onclick="CloseWindow('cancel');">关闭</a>
	                 <a class="mini-button"   plain="true" onclick="allSelect">全选</a>
	            </td>
	        </tr>
	    </table>
	</div>
...
<div id="treegrid1" class="mini-treegrid" style="width:100%;height:90%;"     
    url="${ctxPath}/sys/core/sysTree/listByCatKey.do?catKey=CAT_GRAPHIC_REPORT"
