...
<body>
	...
	<div class="form-container">
		<form id="form1" method="post">
			...
			<input id="table" name="echartsType" class="mini-hidden" value="Pie" />
					...
					<table class="table-detail column-four" cellspacing="1" cellpadding="0" style="margin-top: 0;">
						<tr>
							...
							<td><input id="detailMethod" name="detailMethod" class="mini-radiobuttonlist" valueField="id" textField="text"
								data="[{'id':0, 'text':'行数据对应扇形'}, {'id':1, 'text':'列数据对应扇形'}]"
						...
						<tr>
							<td>开启选中模式</td>
							<td><input id="series-selectedMode" class="mini-radiobuttonlist" valueField="id" textField="text"
								data="[{'id':'none', 'text':'不选中'}, {'id':'single', 'text':'单选'}, {'id':'multiple', 'text':'多选'}]"
								value="single"/></td>
							<td>南丁格尔玫瑰</td>
							<td><input id="series-roseType" class="mini-radiobuttonlist" valueField="id" textField="text"
								data="[{'id':'none', 'text':'不显示'}, {'id':'radius', 'text':'半径显示'}, {'id':'area', 'text':'同角显示'}]"
								value="none"/></td>
						</tr>
						<tr>
							<td>半径</td>
							<td><input id="series-minRadius" class="mini-textbox"
								style="width:60px;font-size:10px;" value="0" maxlength="4" vtype="range:0,100"/>%~
								<input id="series-maxRadius" class="mini-textbox"
								style="width:60px;font-size:10px;" value="50" maxlength="4" vtype="range:0,100"/>%</td>
							<td>中心位置</td>
							<td>
								水平位置<input id="series-center-h" class="mini-textbox"
									style="width:60px;font-size:10px;" value="50%" maxlength="4"/>
								垂直位置<input id="series-center-v" class="mini-textbox"
									style="width:60px;font-size:10px;" value="50%" maxlength="4"/>
							</td>
						</tr>
					</table>
	...
	<script type="text/javascript">
		...
		function selfSaveData() {
			...
			series.selectedMode = (mini.get("series-selectedMode").getValue() == "none" ? false : mini.get("series-selectedMode").getValue());
			series.roseType = (mini.get("series-roseType").getValue() == "none" ? false : mini.get("series-roseType").getValue());
