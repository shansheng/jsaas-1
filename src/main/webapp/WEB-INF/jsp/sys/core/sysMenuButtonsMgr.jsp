...
<html>
		    ...
		    <div title="center" region="center"   showHeader="false" showSplitIcon="false" showSplit="false" style="border:0;padding:5px;">
			    <div id="toolbar1" class="mini-toolbar" style="padding:2px;border-bottom: 1px solid #ccc;">
				    <table style="width:100%;">
				        <tr>
				        <td style="width:100%;">
				            <a class="mini-button"   plain="true" onclick="addButton">添加</a>
				            <a class="mini-button"   plain="true" onclick="addButtons">添加默认全部</a>
				            <a class="mini-button btn-red" iconCls="icon-remove" plain="true" onclick="delSelectedRow">删除</a>
				        </td>
				      </tr>
				    </table>
				</div>
	...
	<script type="text/javascript">
        ...
        function onActionRenderer(e) {
            var record = e.record;
            var uid=record._uid;
            var s = '<span  title="删除" onclick="delRow(\'' + uid + '\')"></span>';
            return s;
        }
