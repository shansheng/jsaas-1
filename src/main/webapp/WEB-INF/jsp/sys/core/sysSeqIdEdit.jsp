		...
		<form id="form1" method="post">
				...
				<table class="table-detail column-four" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td>分类选择 *:</td>
						<td>
							<input id="treeId" name="treeId" class="mini-treeselect" url="${ctxPath}/sys/core/sysTree/listByCatKey.do?catKey=CAT_SERIAL_NUMBER"
								   multiSelect="false" textField="name" valueField="treeId" parentField="parentId"  required="true" value="${sysSeqId.treeId}"
					...
					<tr>
						<td>流水号长度 </td>
						<td><input name="len" value="${sysSeqId.len}" class="mini-spinner" minValue="2" maxValue="100" vtype="maxLength:10" /></td>
						<td>
							<span class="starBox">
