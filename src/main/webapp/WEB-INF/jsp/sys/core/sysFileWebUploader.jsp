...
<body >
	<div id="layout1" class="mini-layout" style="width:100%;height:100%; border:none"  >
	    <div title="south" region="south" showSplit="false" showHeader="false" height="46" showSplitIcon="false" >
			<div class="southBtn">
...
$(function(){
    ...
    uploader.on("error",function (type){
    	if(type == "F_DUPLICATE"){
    	   ...
    	   mini.alert("<p style='white-space:normal;word-wrap:break-word;word-break: break-all;'>上传文件类型出错，请联系管理员!目前允许的上传类型为:<br/>${typeMap}</p>");
       }
    });
