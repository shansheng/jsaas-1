...
<body>
   	<div class="titleBar mini-toolbar" >
         <ul>
			<li>
				<a class="mini-button"  plain="true" onclick="onMutiExport">多表头导出</a>
			</li>
			<li>
				<a class="mini-button"  plain="true" onclick="onSingleExport">单表头导出</a>
			</li>
			<li class="clearfix"></li>
		</ul>
		<ul>
			<li>
				<a class="mini-button"  plain="true" onclick="reloadColumns">重新合并表头</a>
			</li>
			<li>
				<a class="mini-button"   plain="true" onclick="addRow('headerGrid')">添加</a>
			</li>
			<li>
				<a class="mini-button btn-red"  plain="true" onclick="removeRow('headerGrid')">删除</a>
			</li>
			<li>
				<a class="mini-button"  plain="true" onclick="upRow('headerGrid')">向上</a>
			</li>
			<li>
				<a class="mini-button"  plain="true" onclick="downRow('headerGrid')">向下</a>
			</li>
			<li>
				<a class="mini-button"  plain="true" onclick="topRow('headerGrid')">上升一级</a>
			</li>
			<li>
				<a class="mini-button"  plain="true" onclick="subRow('headerGrid')">下降一级</a>
			</li>
			<li class="clearfix"></li>
		</ul>
     </div>
	  ...
	  //添加行
        ...
        function init(data){
			...
			for(var key in data){
				...
				var html="<input type='hidden' name='"+key+"' value='"+val+"' />";
				form.append(html);
			}        	
        }
