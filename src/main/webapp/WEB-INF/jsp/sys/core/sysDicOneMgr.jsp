				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
	                <tr>
	                    ...
	                    <td style="width:80%;">
			                ...
			                <a class="mini-button" onclick="newRow();">添加数据项</a>
			                <c:if test="${showType=='TREE'}">
			                <a class="mini-button" onclick="newSubRow();">添加子数据项</a>
			                </c:if>
			                <a class="mini-button btn-red" onclick="delRow();">删除数据项</a>
	         ...
	         <div class="mini-fit rx-grid-fit" style="border:0;background-color: white;">
		        <div id="sysdicGrid" class="mini-treegrid" style="width:100%;height:100%;"     
		            ...
		            <div property="columns">
		                ...
		                <div name="name" field="name" width="160">项名
		                	<input property="editor" class="mini-textbox" style="width:100%;" required="true"/>
		                </div>
		                <div field="key" name="key" width="80">项Key
		                	<input property="editor" class="mini-textbox" style="width:100%;" required="true"/>
		                </div>
		                <div field="value" name="value" width="80">项值
		                	<input property="editor" class="mini-textbox" style="width:100%;" required="true"/>
		                </div>
		                <div name="descp" field="descp" width="120">项描述
		                	<input property="editor" class="mini-textbox" style="width:100%;" />
		                </div>
		                <div name="sn" field="sn" width="60">序号
