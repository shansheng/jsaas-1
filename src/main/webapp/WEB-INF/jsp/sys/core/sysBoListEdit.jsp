						...
						<c:when test="${sysBoList.isDialog!='YES'}">
							<tr>
								...
								<td>
									...
									编辑:
									<input name="formAlias" value="${sysBoList.formAlias}" text="${sysBoList.formName}" allowInput="false" class="mini-buttonedit" onbuttonclick="selectFormSolution" showClose="true" oncloseclick="_ClearButtonEdit" style="width: 80%" />
									</div>
									<div style="padding: 4px 0">
									明细:
									<input name="formDetailAlias" value="${sysBoList.formDetailAlias}" text="${sysBoList.formDetailName}" allowInput="false" class="mini-buttonedit" onbuttonclick="selectFormSolution" showClose="true" oncloseclick="_ClearButtonEdit" style="width: 80%" />
									</div>
								</td>
							</tr>
							<tr>
