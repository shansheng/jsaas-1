		    	...
		    	<div id="menuForm" >
		    		<table class="table-detail column-two" style="width:100%; " >
		    			...
		    			<tr>
		    				<td>访问方式</td>
		    				<td>
		    					<div class="mini-radiobuttonlist"  required="true" repeatDirection="vertical" name="showType" value="URL" data="[{id:'URL',text:'URL访问'},{id:'NEW_WIN',text:'新窗口'},{id:'TAB_NAV',text:'Tab导航'},{id:'FUNS',text:'功能面板集（标签）'},{id:'FUNS_BLOCK',text:'功能面板集（单页）'},{id:'FUN',text:'功能面板'}]"></div> 
		    				</td>
		    			</tr>
		    			<tr>
		    				<td>菜单类型</td>
