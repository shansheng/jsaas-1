             ...
             <tr>
              ...
              <tr>
                  <td style="white-space:nowrap;padding:5px;" class="search-form" >
                     <ul>
						<li><span class="text">机构类型ID:</span><input class="mini-textbox" name="Q_INST_TYPE_ID__S_LK"></li>
						<li><span class="text">子系统ID:</span><input class="mini-textbox" name="Q_SUB_SYS_ID__S_LK"></li>
					</ul>
                  </td>
              </tr>
         </table>
