...
<body>
				...
				<div id="datagrid1" class="mini-datagrid"
					...
					<div property="columns">
						...
						<div field="nameCn" width="120" headerAlign="center"
							allowSort="true" sortField="NAME_CN_">公司中文名</div>
						<div field="nameEn" width="100" headerAlign="center"
							allowSort="true" sortField="NAME_EN_">公司英文名</div>
						<div field="domain" width="100" headerAlign="center"
							allowSort="true" sortField="DOMAIN_">域名</div>
						<div field="instNo" width="100" headerAlign="center"
							allowSort="true" sortField="INST_NO_">机构编号</div>
						<div field="status" width="60" headerAlign="center"
							allowSort="true" sortField="STATUS_">状态</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = '<span  title="明细" onclick="detailRow(\''
					+ pkId + '\')"></span>';
			return s;
		}
