		 ...
		 <div title="组织机构列表" region="center" showHeader="false" showCollapseButton="false">
		 	<div class="mini-toolbar">
		 		<ul class="toolBtnBox toolBtnBoxTop" id="searchForm">
					<li><input class="mini-textbox" id="instNo" name="instNo" emptyText="机构编码" onenter="search"/></li>
					<li><input class="mini-textbox" id="nameCn" name="nameCn" emptyText="机构名称" onenter="search"/></li>
