				    ...
				    <table style="width:100%;">
				        <tr>
				            <td style="width:100%;" id="toolbarBody">
				               	<a class="mini-button"   onclick="onSave">确定</a>
							...
							<tr>
								...
								<td width="85%">
									<div class="mini-toolbar" style="border-top:none;border-left:none;border-right:none;">
										<span>数据源:</span>
										<input id="ds" name="ds" style="width:250px;" class="mini-buttonedit" onbuttonclick="onSelDatasource" showClose="true" oncloseclick="_ClearButtonEdit"/>
