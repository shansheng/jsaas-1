...
<div class="topToolBar">
	<div>
		<a class="mini-button"  plain="true" onclick="onPre">上一步</a>
		<a class="mini-button"   plain="true" onclick="onSaveConfigJson">保存</a>
		<a class="mini-button"   plain="true" onclick="onGenHtml">生成页面</a>
		<a class="mini-button"   plain="true" onclick="onEditHtml">编辑页面代码</a>
	</div>
</div>
<div class="mini-fit">
	<div class="mini-tabs" style="width:100%;height:100%">
							...
							<div class="searchBox">
								<form action="" id="searchForm" class="search-form">
									<ul>
										...
										<li>
											<span class="text-to"  style="font-size: 14px">列至：</span>
											<input
													id="endFroCol"
													name="endFroCol"
													class="mini-spinner"
													...
													style="width:50px"
											>
											<span style="font-size: 14px;width: auto;min-width: auto;">&nbsp;列</span>
										</li>
									</ul>
								</form>
							</div>
							<ul  class="toolBtnBox">
								<li><a class="mini-button" plain="true" onclick="reloadColumns">重新合并表头</a></li>
								<li><a class="mini-button"   onclick="addRow('headerGrid')">新增行</a></li>
								<li><a class="mini-button btn-red" plain="true" onclick="removeRow('headerGrid')">删除行</a></li>
								<li><a class="mini-button"  plain="true" onclick="upRow('headerGrid')">向上</a></li>
								<li><a class="mini-button"  plain="true" onclick="downRow('headerGrid')">向下</a></li>
								<li><a class="mini-button"  plain="true" onclick="topRow('headerGrid')">上升一级</a></li>
								<li><a class="mini-button"  plain="true" onclick="subRow('headerGrid')">下降一级</a></li>
								<li><a class="mini-button"  plain="true" onclick="expand();">展开</a></li>
								<li><a class="mini-button"  plain="true" onclick="collapse();">收起</a></li>
								<c:if test="${sysBoList.rowEdit=='YES'}">
									<li>
										<a class="mini-button"  plain="true" onclick="rowControlConfig">编辑控件配置</a>
									</li>
								</c:if>
								<li>
									<a class="mini-button"  plain="true" onclick="cellRenderConfig">字段渲染</a>
								</li>
							</ul>
						</div>
						<div class="mini-fit">
							...
							>
								<div property="columns" class="border-right">
									...
									<div name="header" field="header" width="150" >字段名称(*)
										<input property="editor" class="mini-textbox" style="width:100%;" />
									</div>
									<div field="field" width="120" >字段Key(*)
									...
									<div field="mobileShowMode" width="80" >手机端主副显示
										<input
												property="editor"
												class="mini-combobox"
												showNullItem="true"
		...
		<c:if test="${sysBoList.isLeftTree=='YES'}">
			<div title="导航树配置" >
				<div class="mini-toolbar">
					<ul class="toolBtnBox">
						<li><a class="mini-button"   onclick="addTabRow">新增</a></li>
						<li><a class="mini-button btn-red"  onclick="removeTabRow">删除</a></li>
						<li><a class="mini-button" onclick="editTabRow">配置树</a></li>
					</ul>
				</div>
				<div class="mini-fit">
		...
		<div title="搜索条件配置" >
			<div class="form-toolBox">
				<ul >
					<li><a class="mini-button"   plain="true" onclick="addSearchRow">新增条件配置</a></li>
					<li><a class="mini-button btn-red" plain="true" onclick="removeSearchRow">删除条件配置</a></li>
					<li><a class="mini-button"   plain="true" onclick="addSearchSplit">新增分割行</a></li>
					<li><a class="mini-button"  plain="true" onclick="showSearchConfigEditor">配置</a></li>
					<li><a class="mini-button"  plain="true" onclick="moveUpRow('searchGrid')">向上</a></li>
					<li><a class="mini-button" plain="true" onclick="moveDownRow('searchGrid')">向下</a></li>
				</ul>
			</div>
			<div class="mini-fit">
		...
		<c:if test="${isAllowDataGrant==true}">
			<div title="数据权限">
				<div class="mini-toolbar">
					<ul class="toolBtnBox">
						<li><a class="mini-button"   plain="true" onclick="addDataGrantRow">新增权限</a></li>
						<li><a class="mini-button btn-red"   onclick="removeDataGrantRow">删除权限</a></li>
					</ul>
				</div>
				<div style="display:none">
		...
		<c:if test="${sysBoList.isDialog=='NO'}">
			<div title="功能按钮" >
				<div class="form-toolBox">
					<ul>
						<li><a class="mini-button"   plain="true" onclick="addToolbarRow">新增按钮</a></li>
						<li><a class="mini-button"   plain="true" onclick="addToolbarAllRows">新增全部默认</a></li>
						<li><a class="mini-button btn-red"  plain="true" onclick="removeToolbarRow">删除按钮</a></li>
						<li><a class="mini-button"  plain="true" onclick="upRow('toolbarGrid')">向上</a></li>
						<li><a class="mini-button"  plain="true" onclick="downRow('toolbarGrid')">向下</a></li>
						<li><a class="mini-button"  plain="true" onclick="topRow('toolbarGrid')">上升一级</a></li>
						<li><a class="mini-button"  plain="true" onclick="subRow('toolbarGrid')">下降一级</a></li>
						<li><a class="mini-button"   plain="true" onclick="addToolbarSelfRow">新增脚本按钮</a></li>
						<li><a class="mini-button" plain="true" onclick="editToolbarScript">配置自定义处理脚本</a></li>
						<li><a class="mini-button"  plain="true" onclick="joinToolbarRs()">加入权限资源</a></li>
					</ul>
				</div>
				<div class="mini-fit">
				...
				<div class="mini-fit">
					<div id="returnFieldGrid" class="mini-datagrid" style="width:100%;height:100%"
						...
						<div property="columns">
							...
							<div type="checkboxcolumn" name="visible" field="visible" trueValue="YES" falseValue="NO" width="50" headerAlign="center">多选对话框显示</div>
		...
		<div title="页面JS函数定义" >
			<div class="form-toolBox">
				<a class="mini-button" onclick="insertSummaryDrawFunction">插入统计行函数</a>
			</div>

			<textarea id="bodyScript" name="bodyScript" style="width:100%;height:100%;">
				${sysBoList.bodyScript}

			</textarea>
			<textarea id="drawsummarycellArea" style="display: none">
...
<textarea readonly="readonly" style="width:100%;height:48%;border:none;padding: 0;">
	...
	//用一列显示审批明细项
	 if (field== "INST_ID_") {
	 	if(record.INST_ID_!='' && record.INST_STATUS_=='RUNNING'){
			...
			<textarea id="drawCellScript" name="drawCellScript" style="width:100%;height:48%;">${sysBoList.drawCellScript}</textarea>
			<pre>
}
			</pre>
		</div>
...
<script type="text/javascript">
	...
	//字段下拉的编辑控件
	var rowControls=[{id:'mini-textbox',text:'单行文本',tag:'input'},
		{id:'mini-textarea',text:'多行文本',tag:'textarea'},
// 						 {id:'mini-checkbox',text:'复选框',tag:'input'},
// 						 {id:'mini-checkboxlist',text:'复选框列表',tag:'input'},
		{id:'mini-spinner',text:'数字输入',tag:'input'},
		{id:'mini-datepicker',text:'日期',tag:'input'},
// 						 {id:'mini-month',text:'月份',tag:'input'},
// 					     {id:'mini-time',text:'时间',tag:'input'},
		{id:'mini-combobox',text:'下拉选择',tag:'input'},
// 				         {id:'mini-user',text:'用户',tag:'input'},
// 				         {id:'mini-group',text:'用户组',tag:'input'},
// 				         {id:'mini-dep',text:'部门',tag:'input'},
// 			   	         {id:'upload-panel',text:'附件',tag:'input'},
		{id:'mini-buttonedit',text:'编辑按钮',tag:'input'}];
	...
	var cololumRenderTypes=[{renderType:'COMMON',renderTypeName:'普通',isConfig:false},
		...
		{renderType:'IMG',renderTypeName:'图片',isConfig:false},
		{renderType:'APPENDIX',renderTypeName:'附件',isConfig:false},
		...
		{renderType:'CUR_NODE',renderTypeName:'当前节点',isConfig:false},
		{renderType:'CUR_ASSIGNEE',renderTypeName:'审批执行人',isConfig:false},
		{renderType:'OVER_TIME',renderTypeName:'流程节点超时预警',isConfig:false},
	...
	bodyScriptEditor.setSize('auto','80%');
	...
	drawCellScriptEditor.setSize('auto','40%');
	...
	var btns=[{toolId:'1',toolPid:'0',btnLabel:'新增',btnName:'Add',btnIconCls:'',
		btnClick:'onAdd',url:'/sys/customform/sysCustomFormSetting/${sysBoList.formAlias}/add.do'},
		<c:if test="${sysBoList.dataStyle=='tree'}">
		{toolId:'11',toolPid:'0',btnLabel:'新增子记录',btnName:'AddSub',btnIconCls:' ',btnClick:'onAddSub'},
		{toolId:'21',toolPid:'0',btnLabel:'展开',btnName:'Expand',btnIconCls:' ',btnClick:'onExpand'},
		{toolId:'31',toolPid:'0',btnLabel:'收起',btnName:'Collapse',btnIconCls:' ',btnClick:'onCollapse'},
		</c:if>
		{toolId:'2',toolPid:'0',btnLabel:'编辑',btnName:'Edit',btnIconCls:'',btnClick:'onEdit',
			url:'/sys/customform/sysCustomFormSetting/${sysBoList.formAlias}/edit.do?pk={pk}'
		},
		{toolId:'3',toolPid:'0',btnLabel:'删除',btnName:'Remove',btnIconCls:'',btnClick:'onRemove',
			url:'/sys/customform/sysCustomFormSetting/${sysBoList.formAlias}/removeById.do'
		},
		{toolId:'4',toolPid:'0',btnLabel:'明细',btnName:'Detail',btnIconCls:'',btnClick:'onDetail',
			url:'/sys/customform/sysCustomFormSetting/${sysBoList.formDetailAlias}/detail.do?pk={pk}'
		},
		{toolId:'5',toolPid:'0',btnLabel:'关闭',btnName:'Close',btnIconCls:'',btnClick:'onClose'},
		...
		{toolId:'8',toolPid:'0',btnLabel:'导出',btnName:'Export',btnIconCls:'',btnClick:'onExport'},
		{toolId:'10',toolPid:'8',btnLabel:'导出EXCEL',btnName:'XLSExport',btnIconCls:'',btnClick:'onXLSExport',
			url:'/sys/core/sysBoList/${sysBoList.formAlias}/exportExcelDialog.do'
		},
		{toolId:'11',toolPid:'0',btnLabel:'导入',btnName:'Import',btnIconCls:'',btnClick:'onImport',
	...
	function showSearchConfigEditor(){
		...
		_OpenWindow({
			...
			ondestroy:function(action){
				...
				if(data && !data.fieldOp && data.opType ){
					data.fieldOp =data.opType;
				}
	...
	function onSaveConfigJson(){
		...
		if(isDialog=='NO'){
			...
			var returnFieldGrid=mini.get('returnFieldGrid');
			var ary = returnFieldGrid.getData();
			for(var i=0;i<ary.length;i++){
				if(!ary[i].visible){
					ary[i].visible = "NO";
				}
			}
			fieldJson=mini.encode(ary);
		}
		if(!isValid){
		...
		_SubmitJson({
			...
			data:{
				...
				isDialog:isDialog,
				colsJson:mini.encode(newColumns),
	...
	function rowControlConfig(){
		...
		_OpenWindow({
			...
			onload:function(){
				var iframe = this.getIFrameEl();
				var win=iframe.contentWindow;
				var controlConf=mini.decode(row.controlConf);
				controlConf.field=row.field;
				win.setData(controlConf);
				if(win.setColumnFields){
					//将当前的列设置到  编辑按钮绑定返回字段上  做表格行字段绑定
					win.setColumnFields(curField);
				}
			},
			ondestroy:function(action){
				if(action!='ok'){
