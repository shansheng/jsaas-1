	...
	<div style="padding-left: 6px; padding-right: 6px;">
		<div class="mini-toolbar" style="margin: 0; padding: 0;">
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-upload" onclick="uploadTemplate()" plain="true">上传</a> <a class="mini-button btn-red" onclick="CloseWindow()" plain="true">关闭</a> <a class="mini-button" iconCls="icon-help" onclick="showTip()" plain="true">上传帮助</a></td>
				</tr>
			</table>
		</div>
