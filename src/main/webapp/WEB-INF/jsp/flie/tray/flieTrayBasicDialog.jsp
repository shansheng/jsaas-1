...
<body>
	<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		 ...
		 <div title="用户组" region="west" width="180"  showSplitIcon="true" showHeader="false" bodyStyle="overflow: auto;">
		 	<input id="dimCombo" class="mini-combobox" style="width:100%;" onvaluechanged="onDimChange" 
			    url="${ctxPath}/sys/org/osDimension/jsonAll.do?containContact=yes&tenantId=<c:out value="${param.tenantId}" />" textField="name" valueField="dimId" value="${adminDim.dimId}" text="${adminDim.name}"/> 
		 	<div id="groupTree" class="mini-tree"  url="${ctxPath}/sys/org/sysOrg/listByDimId.do?tenantId=<c:out value="${param.tenantId}" />&dimId=${adminDim.dimId}" style="width:100%;" 
					showTreeIcon="true"  resultAsTree="false" textField="name" idField="groupId" parentField="parentId" onbeforeload="onBeforeGridTreeLoad"
		  ...
		  <c:if test="${param['single']==false}">
				<div region="east" title="选中用户列表" width="250" showHeader="false" showCollapseButton="false">
					...
					<div class="mini-fit form-outer4">
						<div id="selectedUserGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" url="" 
								idField="userId" multiSelect="true" showColumnsMenu="true" allowAlternating="true" showPager="false" onrowdblclick="removeUser(e)">
		 ...
		 <div region="center" title="用户列表"   showHeader="false" showCollapseButton="false" style=" mini-toolbar-bottom">
				...
				<div class="mini-fit rx-grid-fit form-outer4">
					<div id="userGrid" class="mini-datagrid"  style="width: 100%; height: 100%;" allowResize="false" url="${ctxPath}/sys/org/osUser/search.do?tenantId=<c:out value="${param.tenantId}" />" 
						idField="userId"  onbeforeload="userLoaded"
						<c:choose>
