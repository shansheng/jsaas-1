...
<body>
	<div id="toolbar1" class="mini-toolbar" style="padding: 2px;">
		<table style="width: 100%;">
			<tr>
				<td style="width: 30%;">
				<a class="mini-button"
					iconCls="icon-writemail" plain="true" onclick="writeMail">写信</a><a class="mini-button btn-red"
					iconCls="icon-remove" plain="true" onclick="todelfolder">刪除</a> <a
					class="mini-button btn-red" iconCls="icon-trash" plain="true" onclick="Del">彻底删除</a>
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = '<span  title="查看" onclick="getRow1(\''
					+ pkId
					+ '\')"></span>'
					+ ' <span  title="删除" onclick="rowToDel(\''
					+ pkId + '\')"></span>';
			return s;
		}
