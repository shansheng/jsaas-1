			...
			<div class="mini-splitter" style="width: 100%; height: 100%;"
				...
				<div size="180" maxSize="250" minSize="100"
						...
						<table style="width: 100%;" cellpadding="0" cellspacing="0">
							<tr>
								<td style="width: 100%;"><a class="mini-button"
									  plain="true" onclick="addNode()">添加</a> <a
					...
					<ul id="treeMenu" class="mini-contextmenu"
						...
						<li name="brother"   onclick="onAddAfter">插入同级节点</li>
						<li name="children"   onclick="onAddNode">插入子节点</li>
						<li name="edit" iconCls="icon-edit" onclick="onEditNode">编辑节点</li>
						<li name="remove" iconCls="icon-remove" class=" btn-red" onclick="onRemoveNode">删除节点</li>
					</ul>
						...
						<table style="width: 100%;">
							<tr>
								<td style="width: 100%;"><a class="mini-button"
									...
									class="mini-button btn-red" iconCls="icon-remove" plain="true">删除</a></td>
							</tr>
						</table>
					</div>
					<!--Tabs-->
