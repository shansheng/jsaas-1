	...
	<div id="layout1" class="mini-layout"
		...
		<div region="west" showSplit="true" showHeader="false" width="200">
			...
			<ul id="treeMenu" class="mini-contextmenu"
				...
				<li name="recpmail"   onclick="onAddAfter">收取邮件</li>
				<li name="brother"   onclick="onAddAfter">插入同级文件夹</li>
				<li name="children"   onclick="onAddNode">插入子文件夹</li>
				<li name="edit" iconCls="icon-edit" onclick="onEditNode">编辑文件夹</li>
				<li name="remove" iconCls="icon-remove" class=" btn-red" onclick="onRemoveNode">删除文件夹</li>
			</ul>
		</div>
