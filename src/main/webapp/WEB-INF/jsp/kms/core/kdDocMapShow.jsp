...
<body style="min-width: 1600px;">
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="cmmtHide" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowUp.png'); background-repeat: no-repeat;cursor: pointer;" onclick="hide('cmmt','cmmtShow','cmmtHide')"></span> 
			<span id="cmmtShow" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowDown.png'); background-repeat: no-repeat;cursor: pointer;" onclick="show('cmmt','cmmtShow','cmmtHide')"></span>
		</div>
		<div id="cmmt">
			<div id="myCmmt">
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="remHide" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowUp.png'); background-repeat: no-repeat;cursor: pointer;" onclick="hide('rem','remShow','remHide')"></span> 
			<span id="remShow" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowDown.png'); background-repeat: no-repeat;cursor: pointer;" onclick="show('rem','remShow','remHide')"></span>
		</div>
		<div id="rem">
			<div id="myRem">
				<div style="margin-left: 5px; margin-top: 10px;">
					<div style="font-weight: 600; color: #545454; font-size: 15px;">
						...
						<a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 5px;"   onclick="clearAll()">清空用户</a>
					</div>
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="readHide" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowUp.png'); background-repeat: no-repeat;cursor: pointer;" onclick="hide('read','readShow','readHide')"></span> 
			<span id="readShow" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowDown.png'); background-repeat: no-repeat;cursor: pointer;" onclick="show('read','readShow','readHide')"></span>
		</div>
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="hisHide" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowUp.png'); background-repeat: no-repeat;cursor: pointer;" onclick="hide('his','hisShow','hisHide')"></span> 
			<span id="hisShow" style="height: 20px; width: 20px; float: right; background-image: url('${ctxPath}/styles/icons/arrowDown.png'); background-repeat: no-repeat;cursor: pointer;" onclick="show('his','hisShow','hisHide')"></span>
		</div>
