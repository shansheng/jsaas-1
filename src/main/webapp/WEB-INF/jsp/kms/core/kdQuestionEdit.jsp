...
<body>
	<div class="topToolBar" style="padding: 2px;">
		<div>
			<a class="mini-button"  plain="true" onclick="saveQuestion">保存</a> 
			<a class="mini-button btn-red" plain="true" onclick="CloseWindow('ok')">取消</a>
		</div>
	</div>
	<div class="mini-fit">
		...
		<form id="form1" method="post">
			<div class="form-inner">
				...
				<table class="table-detail column_2" cellspacing="1" cellpadding="0" style="width:100%">
					...
					<tr>
						<td width="15%">问题内容 <span class="star">*</span> 
						</td>
					...
					<tr>
						<td width="15%" >问题补充（选填） </td><td><a id="desc" class="mini-button" plain="true" onclick="changeDesc">展开</a></td>
					</tr>
