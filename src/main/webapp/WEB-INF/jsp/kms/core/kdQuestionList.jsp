...
<body>
	<div class="form-toolBox">
		<ul>
			<li><a class="mini-button"   onclick="addQuestion">新增</a></li>
			<li><a class="mini-button"  onclick="getQuestion()">查看</a></li>
			<li><a class="mini-button"  onclick="editQuestion()">编辑</a></li>
			<li><a class="mini-button btn-red"   onclick="delQuestion()">删除</a></li>
			<li><a class="mini-button"   onclick="refresh">刷新</a></li>
		</ul>
	</div>
	...
	<div class="mini-fit  rx-grid-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" url="${ctxPath}/kms/core/kdQuestion/getByPath.do?treeId=${param['treeId']}" idField="queId" multiSelect="true" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" pageSize="20" allowAlternating="true" pagerButtons="#pagerButtons">
			<div property="columns">
				...
				<div field="subject" width="120" headerAlign="" allowSort="true">问题标签</div>
				<div field="tags" width="120" headerAlign="" allowSort="true">标签</div>
				<div field="rewardScore" width="120" headerAlign="" allowSort="true" align="center">悬赏货币</div>
				<div field="replyType" width="120" headerAlign="" allowSort="true" align="center">回复者类型</div>
				<div field="status" width="120" headerAlign="" allowSort="true" align="center" renderer="onStatusRenderer">问题状态</div>
				<div field="replyCounts" width="120" headerAlign="" allowSort="true" align="center">回复数</div>
			</div>
		</div>
	</div>
...
<redxun:gridScript gridId="datagrid1" entityName="com.redxun.kms.core.entity.KdQuestion" winHeight="450" winWidth="700" entityTitle="[KdQuestion]" baseUrl="kms/core/kdQuestion" />
	<script type="text/javascript">
	        ...
	        function onActionRenderer(e) {
	            ...
	            var s = ' <span  title="编辑" onclick="editQuestion(\'' + pkId + '\')">编辑</span>'
						+ '<span  title="明细" onclick="getQuestion(\'' + pkId + '\')">明细</span>'
	                    + ' <span  title="删除" onclick="delQuestion(\'' + pkId + '\')">删除</span>';
	            return s;
	        }
