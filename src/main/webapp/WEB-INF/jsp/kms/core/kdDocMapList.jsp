...
<body>
	...
	<div class="mini-toolbar" >
			<table style="width:100%;">
		          <tr>
		            <th style="width:100%;">
						<a class="mini-button"   plain="true" onclick="addMap()">添加</a>
						...
						<a class="mini-button btn-red" iconCls="icon-remove" plain="true" onclick="delMap()">删除</a>
	...
	<script type="text/javascript">
	        ...
	        function onActionRenderer(e) {
	            ...
	            var s = '<span  title="明细" onclick="detailMap(\'' + pkId + '\')"></span>'
	                    + ' <span  title="编辑" onclick="editMap(\'' + pkId + '\')"></span>'
	                    + ' <span  title="删除" onclick="delMap(\'' + pkId + '\')"></span>';
	            return s;
	        }
        </script>
