...
<body style="min-width: 1600px;">
	...
	<div style="margin-left: 100px;">
		<form id="form1" method="post">
			...
			<table class="gridtable" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td style="vertical-align: top;">知识正文内容 </td>
					<td class="tableBox">
				...
				<tr>
					<td style="vertical-align: top;">封面图 </td>
					<td>
						<input 
							name="coverImgId" 
				...
				<tr>
					<td style="vertical-align: top;">可编辑的</td>
					<td>
						<div style="float: left; width: 500px;">
							<textarea 
								class="mini-textboxlist" 
				...
				<tr>
					<td style="vertical-align: top;">附件权限</td>
					<td>
						<div style="float: left; width: 500px;">
							<textarea 
								class="mini-textboxlist" 
	...
	var attFileids = mini.get('#attFileids');
