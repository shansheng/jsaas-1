					...
					<c:if test="${tab=='index'}">
						<c:forEach items="${askMeQuestion}" var="question" varStatus="status">
							<tr>
								<td>
									<!-- <div class="user">
										<a href="#"> <img src="${ctxPath}/styles/images/te.png" width="40" /></a>
									</div> -->
									<div class="ask-me">
						...
						<!-- 	<tr>
							<td>
								<div class="user">
									<a href="#"> <img src="${ctxPath}/styles/images/te.png" width="46" /></a>
								</div>
								<div class="ask-me">
									<div class="ask-me-info">
										<div class="ask-me-info-list">
					...
					if(tab=='ask'){
						for (var i = 0; i < data.length; i++) {
							...
							if(data[i].status=='UNSOLVED'){
								...
								if(data[i].replyCounts<=0)
									li+="<i style='background-repeat: no-repeat;background-image: url(${ctxPath}/styles/icons/icon-unsolved.png);'></i>";
								else
									li+="<a href='${ctxPath}/kms/core/kdQuestion/get.do?pkId="+data[i].queId+"' target='_blank'>查看并处理</a>";
								li+="</div>";	
							}
							else if(data[i].status=='SOLVED'){
								li+="<div class='handle'><i style='background-repeat: no-repeat;background-image: url(${ctxPath}/styles/icons/icon-right.png);'></i></div>";
							}
						...
						for (var i = 0; i < data.length; i++) {
							...
							if(question.status=='UNSOLVED'){
								li+="<i style='background-image: url(${ctxPath}/styles/icons/icon-unsolved.png)'></i>";
							}
							else{
								if(data[i].isBest=='NO'){
									li+="<i style='background-image: url(${ctxPath}/styles/icons/icon-noadopt.png)'></i>";
								}
								if(data[i].isBest=='YES'){
									li+="<i style='background-image: url(${ctxPath}/styles/icons/icon-adopt.png)'></i>";
								}
							}
