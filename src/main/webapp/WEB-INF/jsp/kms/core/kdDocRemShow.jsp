	...
	<div style="margin-left: 100px;">
		<form id="form1" method="post">
			<table class="gridtable" cellspacing="1" cellpadding="0">
				...
				<tr>
					<th></th>
					<td><a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" onclick="addPerson(rem)">新增用户</a>
					<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" onclick="addGroup(rem)">新增用户组</a>
					<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;"   onclick="clearAll()">清空用户</a></td>
					</td>
				</tr>
