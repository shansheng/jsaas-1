		...
		<div style="padding:20px 60px;position: relative;border: 2px solid #00FFFF;"><!-- question desc -->
			...
			<div style="margin-top: 10px;margin-bottom: 5px;line-height: 20px;font-size: 14px;">
				<div style="text-align: right;">
					...
					<a id="closeQuestion" style="cursor:pointer;margin:0px 15px;text-decoration: none;color: #2d64b3;"><i style="margin-right:5px;height: 16px;width: 16px;vertical-align: middle;background-image: url('${ctxPath}/styles/icons/remove.gif');background-repeat: no-repeat;"></i>关闭问题</a>
				</div>
