			...
			<table class="gridtable" cellspacing="1" cellpadding="0">
				...
				<tr>
					...
					<td><div style="float: left; width: 500px;">
						...
						</div> <input id="editPerson" name="editPerson" class="mini-hidden" value="" /> <input id="editGroup" name="editGroup" class="mini-hidden" value="" /> <a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 15px;" iconCls="icon-addMsgPerson" onclick="addPerson(editable,editPerson)">新增用户</a><br /> <a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 5px;" iconCls="icon-addMsgGroup" onclick="addGroup(editable,editGroup)">新增用户组</a><br /> <a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 5px;"   onclick="clearAll()">清空用户</a>
				...
				<tr>
					...
					<td><div style="float: left; width: 500px;">
						...
						</div> <input id="downloadPerson" name="downloadPerson" class="mini-hidden" value="" /> <input id="downloadGroup" name="downloadGroup" class="mini-hidden" value="" /> <a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 15px;" iconCls="icon-addMsgPerson" onclick="addPerson(downloadable,downloadPerson)">新增用户</a><br /> <a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 5px;" iconCls="icon-addMsgGroup" onclick="addGroup(downloadable,downloadGroup)">新增用户组</a><br /> <a class="mini-button" style="width: 100px; margin-left: 10px; margin-top: 5px;"   onclick="clearAll()">清空用户</a>
