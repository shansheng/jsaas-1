			...
			<table style="width: 100%;" class="gridtable" cellspacing="1" cellpadding="0">
				<tr>
					...
					<td><div style="float: left; width: 500px;">
						...
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 15px;" onclick="addPerson(readable)">新增用户</a>
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" onclick="addGroup(readable)">新增用户组</a>
				...
				<tr>
					...
					<td><div style="float: left; width: 500px;">
							<textarea class="mini-textboxlist"
									  allowInput="false" validateOnChanged="false"
									  style="margin-top: 5px;" id="editable" name="editable" width="500px" height="100px"></textarea>
						</div> 

						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 15px;" onclick="addPerson(editable)">新增用户</a>
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" onclick="addGroup(editable)">新增用户组</a>
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;"   onclick="clearAll()">清空用户</a>
				...
				<tr>
					...
					<td><div style="float: left; width: 500px;">
							<textarea class="mini-textboxlist"
									  allowInput="false" validateOnChanged="false"
									  style="margin-top: 5px;" id="downloadable"
									  name="downloadable" width="500px" height="100px"
							></textarea>
						</div> 
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 15px;" onclick="addPerson(downloadable)">新增用户</a>
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" onclick="addGroup(downloadable)">新增用户组</a>
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;"   onclick="clearAll()">清空用户</a>
						<div style="clear:both;color:#945151;">（如果为空则默认所有人都可以下载）
							<div id="ck1" name="product" class="mini-checkbox" readOnly="false" text="勾选则所有人不可以下载附件" ></div></div></td>
